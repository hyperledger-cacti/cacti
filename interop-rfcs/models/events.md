...
The events generated by a distributed ledger can fall into one of three categories, application events, system events, or Graphene events.
...
Graphene events are events registered by an application Dapp with the Graphene Dapp. Graphene events are captured in the ledger's world state. Examples of Graphene events include:
  * A *delivered event* generated by a logistics Dapp is registered with the Graphene Dapp. The event is pushed to a remote trade finance network to initiate payment settlement.
