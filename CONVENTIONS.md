...
| `cacti-weaver-` | **Weaver packages** (e.g., `cacti-weaver-sdk-fabric`) |
...
(e.g., `cacti-test-plugin-htlc-eth-besu`)

npm scope: `@hyperledger/<package-name>` (most packages) or
`@hyperledger-cacti/<package-name>` (some newer packages, e.g. COPM)
...
- To report vulnerabilities please check
...
- All packages share version `3.0.0-alpha.8` (Lerna fixed mode)
