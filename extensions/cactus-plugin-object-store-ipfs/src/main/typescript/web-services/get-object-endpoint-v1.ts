...
export class GetObjectEndpointV1 implements IWebServiceEndpoint {
  public static readonly CLASS_NAME = "GetObjectEndpointV1";

  private readonly log: Logger;
  private readonly plugin: IPluginObjectStore;

  public get className(): string {
    return GetObjectEndpointV1.CLASS_NAME;
  }

  constructor(public readonly options: IGetObjectEndpointV1Options) {
  ...
  private getOperation() {
    return OAS.paths[
      "/api/v1/plugins/@hyperledger-cacti/cactus-plugin-object-store-ipfs/get-object"
    ].post;
  }
  ...
  async handleRequest(req: Request, res: Response): Promise<void> {
    ...
    try {
      const reqBody = req.body as GetObjectRequestV1;
