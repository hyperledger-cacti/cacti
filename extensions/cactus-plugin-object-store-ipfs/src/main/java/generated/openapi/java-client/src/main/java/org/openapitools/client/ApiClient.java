...
public class ApiClient {
    ...
    private String basePath = "https://www.cactus.stream";
    protected List<ServerConfiguration> servers = new ArrayList<ServerConfiguration>(Arrays.asList(
    new ServerConfiguration(
      "https://www.cactus.stream/{basePath}",
      "Public test instance",
      new HashMap<String, ServerVariable>() {{
        put("basePath", new ServerVariable(
    ...
    private void init() {
        ...
        setUserAgent("OpenAPI-Generator/1/java");
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://www.cactus.stream
