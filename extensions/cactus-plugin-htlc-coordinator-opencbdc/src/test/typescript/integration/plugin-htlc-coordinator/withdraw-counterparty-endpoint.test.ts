...
test(testCase, async (t: Test) => {
  ...
  const htlcCoordinatorOpenCBDCApi = new HtlcCoordinatorOpenCBDCApi(configuration);
  ...
  const response = await htlcCoordinatorOpenCBDCApi.ownHtlcV1(ownHTLCRequest);
  ...
  const response2 = await htlcCoordinatorOpenCBDCApi.counterpartyHtlcV1(
    counterpartyHTLCRequest,
  );
  ...
  const response3 = await htlcCoordinatorOpenCBDCApi.withdrawCounterpartyV1(
