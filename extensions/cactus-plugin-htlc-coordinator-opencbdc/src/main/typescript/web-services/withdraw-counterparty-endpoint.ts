...
import { WithdrawCounterpartyTxReverted } from "../plugin-htlc-coordinator-opencbdc";
...
export class WithdrawCounterpartyEndpoint implements IWebServiceEndpoint {
  ...
  public getOasPath() {
    return OAS.paths[
      "/api/v1/plugins/@hyperledger/cactus-plugin-htlc-coordinator-opencbdc/withdraw-counterparty"
    ];
  }
