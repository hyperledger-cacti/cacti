...
export interface IPluginHTLCCoordinatorOpenCBDCOptions
  extends ICactusPluginOptions {
  pluginRegistry: PluginRegistry;
  logLevel?: LogLevelDesc;
}

export class PluginHTLCCoordinatorOpenCBDC
  ...
  public static readonly CLASS_NAME = "PluginHTLCCoordinatorOpenCBDC";

  public get className(): string {
    return PluginHTLCCoordinatorOpenCBDC.CLASS_NAME;
  }

  constructor(public readonly options: IPluginHTLCCoordinatorOpenCBDCOptions) {
  ...
  public getPackageName(): string {
    return `@hyperledger/cactus-plugin-htlc-coordinator-opencbdc`;
  }
