...
func (amc *AssetManagementContract) LockAsset(ctx contractapi.TransactionContextInterface, assetAgreementSerializedProto64 string, lockInfoSerializedProto64 string) (bool, error) {
    assetAgreementSerializedProto, _ := base64.StdEncoding.DecodeString(assetAgreementSerializedProto64)
    lockInfoSerializedProto, _ := base64.StdEncoding.DecodeString(lockInfoSerializedProto64)
