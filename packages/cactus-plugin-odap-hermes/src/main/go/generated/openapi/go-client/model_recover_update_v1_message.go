...
type RecoverUpdateV1Message struct {
	...
	RecoveredLogs []OdapLocalLog `json:"recoveredLogs"`
...
func NewRecoverUpdateV1Message(sessionID string, recoveredLogs []OdapLocalLog, signature string) *RecoverUpdateV1Message {
...
func (o *RecoverUpdateV1Message) GetRecoveredLogs() []OdapLocalLog {
	if o == nil {
		var ret []OdapLocalLog
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *RecoverUpdateV1Message) GetRecoveredLogsOk() ([]OdapLocalLog, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *RecoverUpdateV1Message) SetRecoveredLogs(v []OdapLocalLog) {
	o.RecoveredLogs = v
}
