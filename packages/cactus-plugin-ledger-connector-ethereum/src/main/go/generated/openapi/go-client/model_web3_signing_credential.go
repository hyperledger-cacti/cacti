...
type Web3SigningCredential struct {
	Web3SigningCredentialCactiKeychainRef *Web3SigningCredentialCactiKeychainRef
...
// Web3SigningCredentialCactiKeychainRefAsWeb3SigningCredential is a convenience function that returns Web3SigningCredentialCactiKeychainRef wrapped in Web3SigningCredential
func Web3SigningCredentialCactiKeychainRefAsWeb3SigningCredential(v *Web3SigningCredentialCactiKeychainRef) Web3SigningCredential {
	return Web3SigningCredential{
		Web3SigningCredentialCactiKeychainRef: v,
	}
}
...
func (dst *Web3SigningCredential) UnmarshalJSON(data []byte) error {
	var err error
	match := 0
	// try to unmarshal data into Web3SigningCredentialCactiKeychainRef
	err = newStrictDecoder(data).Decode(&dst.Web3SigningCredentialCactiKeychainRef)
	if err == nil {
		jsonWeb3SigningCredentialCactiKeychainRef, _ := json.Marshal(dst.Web3SigningCredentialCactiKeychainRef)
		if string(jsonWeb3SigningCredentialCactiKeychainRef) == "{}" { // empty struct
			dst.Web3SigningCredentialCactiKeychainRef = nil
		} else {
			match++
		}
	} else {
...
func (src Web3SigningCredential) MarshalJSON() ([]byte, error) {
	if src.Web3SigningCredentialCactiKeychainRef != nil {
		return json.Marshal(&src.Web3SigningCredentialCactiKeychainRef)
	}
...
func (obj *Web3SigningCredential) GetActualInstance() (interface{}) {
	...
	if obj.Web3SigningCredentialCactiKeychainRef != nil {
		return obj.Web3SigningCredentialCactiKeychainRef
	}
