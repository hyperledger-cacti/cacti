...
export class DeployContractNoKeychainEndpoint implements IWebServiceEndpoint {
  public static readonly CLASS_NAME = "DeployContractNoKeychainEndpoint";

  private readonly log: Logger;

  public get className(): string {
    return DeployContractNoKeychainEndpoint.CLASS_NAME;
  }
  ...
  public get oasPath(): (typeof OAS.paths)["/api/v1/plugins/@hyperledger/cactus-plugin-ledger-connector-ethereum/deploy-contract-no-keychain"] {
    return OAS.paths[
  ...
  public async handleRequest(req: Request, res: Response): Promise<void> {
    ...
    try {
      res
        .status(200)
        .json(await this.options.connector.deployContractNoKeychain(req.body));
    } catch (ex) {
