...
public class Web3TransactionReceipt {
  ...
  public static final String SERIALIZED_NAME_REVERT_REASON = "revertReason";
  @SerializedName(SERIALIZED_NAME_REVERT_REASON)
  ...
  public static final String SERIALIZED_NAME_COMMITMENT_HASH = "commitmentHash";
  @SerializedName(SERIALIZED_NAME_COMMITMENT_HASH)
  ...
  **/
  ...
  public Web3TransactionReceipt transactionIndex(String transactionIndex) {
  ...
  **/
  ...
  public Web3TransactionReceipt blockNumber(String blockNumber) {
  ...
  **/
  ...
  public Web3TransactionReceipt gasUsed(String gasUsed) {
  ...
  **/
  ...
  public Web3TransactionReceipt effectiveGasPrice(String effectiveGasPrice) {
  ...
  **/
  ...
  public Web3TransactionReceipt logs(List<Object> logs) {
    
    this.logs = logs;
    return this;
  }

  public Web3TransactionReceipt addLogsItem(Object logsItem) {
    if (this.logs == null) {
      this.logs = null;
    }
  ...
  **/
  ...
  public Web3TransactionReceipt logsBloom(String logsBloom) {
  ...
  **/
  ...
  public Web3TransactionReceipt revertReason(String revertReason) {
  ...
  **/
  ...
  public Web3TransactionReceipt output(String output) {
  ...
  **/
  ...
  public Web3TransactionReceipt commitmentHash(String commitmentHash) {
  ...
  **/
  ...
  public Web3TransactionReceipt cumulativeGasUsed(String cumulativeGasUsed) {
  ...
  **/
  ...
  public Web3TransactionReceipt type(String type) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.status, web3TransactionReceipt.status) &&
        ...
        Objects.equals(this.effectiveGasPrice, web3TransactionReceipt.effectiveGasPrice) &&
        ...
        Objects.equals(this.logs, web3TransactionReceipt.logs) &&
        Objects.equals(this.logsBloom, web3TransactionReceipt.logsBloom) &&
        Objects.equals(this.revertReason, web3TransactionReceipt.revertReason) &&
        Objects.equals(this.output, web3TransactionReceipt.output) &&
        Objects.equals(this.commitmentHash, web3TransactionReceipt.commitmentHash) &&
        Objects.equals(this.cumulativeGasUsed, web3TransactionReceipt.cumulativeGasUsed) &&
        Objects.equals(this.type, web3TransactionReceipt.type)&&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(status, transactionHash, transactionIndex, blockHash, blockNumber, gasUsed, effectiveGasPrice, contractAddress, from, to, logs, logsBloom, revertReason, output, commitmentHash, cumulativeGasUsed, type, additionalProperties);
  }
  ...
  static {
    ...
    openapiFields.add("revertReason");
    openapiFields.add("output");
    openapiFields.add("commitmentHash");
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      ...
      if (jsonObj.get("logs") != null && !jsonObj.get("logs").isJsonArray()) {
      ...
      if ((jsonObj.get("revertReason") != null && !jsonObj.get("revertReason").isJsonNull()) && !jsonObj.get("revertReason").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `revertReason` to be a primitive type in the JSON string but got `%s`", jsonObj.get("revertReason").toString()));
      }
      ...
      if ((jsonObj.get("commitmentHash") != null && !jsonObj.get("commitmentHash").isJsonNull()) && !jsonObj.get("commitmentHash").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `commitmentHash` to be a primitive type in the JSON string but got `%s`", jsonObj.get("commitmentHash").toString()));
      }
