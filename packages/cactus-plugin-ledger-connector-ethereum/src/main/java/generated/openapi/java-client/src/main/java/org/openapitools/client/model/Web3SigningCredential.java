...
public class Web3SigningCredential extends AbstractOpenApiSchema {
    ...
    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            ...
            final TypeAdapter<Web3SigningCredentialCactiKeychainRef> adapterWeb3SigningCredentialCactiKeychainRef = gson.getDelegateAdapter(this, TypeToken.get(Web3SigningCredentialCactiKeychainRef.class));
            final TypeAdapter<Web3SigningCredentialGethKeychainPassword> adapterWeb3SigningCredentialGethKeychainPassword = gson.getDelegateAdapter(this, TypeToken.get(Web3SigningCredentialGethKeychainPassword.class));
            ...
            return (TypeAdapter<T>) new TypeAdapter<Web3SigningCredential>() {
                ...
                public void write(JsonWriter out, Web3SigningCredential value) throws IOException {
                    ...
                    // check if the actual instance is of the type `Web3SigningCredentialCactiKeychainRef`
                    if (value.getActualInstance() instanceof Web3SigningCredentialCactiKeychainRef) {
                        JsonObject obj = adapterWeb3SigningCredentialCactiKeychainRef.toJsonTree((Web3SigningCredentialCactiKeychainRef)value.getActualInstance()).getAsJsonObject();
                        elementAdapter.write(out, obj);
                        return;
                    }

                    // check if the actual instance is of the type `Web3SigningCredentialGethKeychainPassword`
                    if (value.getActualInstance() instanceof Web3SigningCredentialGethKeychainPassword) {
                        JsonObject obj = adapterWeb3SigningCredentialGethKeychainPassword.toJsonTree((Web3SigningCredentialGethKeychainPassword)value.getActualInstance()).getAsJsonObject();
                        elementAdapter.write(out, obj);
                        return;
                    }
                    ...
                    throw new IOException("Failed to serialize as the type doesn't match oneOf schemas: Web3SigningCredentialCactiKeychainRef, Web3SigningCredentialGethKeychainPassword, Web3SigningCredentialNone, Web3SigningCredentialPrivateKeyHex");
                }
                ...
                public Web3SigningCredential read(JsonReader in) throws IOException {
                    ...
                    // deserialize Web3SigningCredentialCactiKeychainRef
                    try {
                        // validate the JSON object to see if any exception is thrown
                        Web3SigningCredentialCactiKeychainRef.validateJsonObject(jsonObject);
                        actualAdapter = adapterWeb3SigningCredentialCactiKeychainRef;
                        match++;
                        log.log(Level.FINER, "Input data matches schema 'Web3SigningCredentialCactiKeychainRef'");
                    } catch (Exception e) {
                        // deserialization failed, continue
                        errorMessages.add(String.format("Deserialization for Web3SigningCredentialCactiKeychainRef failed with `%s`.", e.getMessage()));
                        log.log(Level.FINER, "Input data does not match schema 'Web3SigningCredentialCactiKeychainRef'", e);
                    }

                    // deserialize Web3SigningCredentialGethKeychainPassword
                    try {
                        // validate the JSON object to see if any exception is thrown
                        Web3SigningCredentialGethKeychainPassword.validateJsonObject(jsonObject);
                        actualAdapter = adapterWeb3SigningCredentialGethKeychainPassword;
                        match++;
                        log.log(Level.FINER, "Input data matches schema 'Web3SigningCredentialGethKeychainPassword'");
                    } catch (Exception e) {
                        // deserialization failed, continue
                        errorMessages.add(String.format("Deserialization for Web3SigningCredentialGethKeychainPassword failed with `%s`.", e.getMessage()));
                        log.log(Level.FINER, "Input data does not match schema 'Web3SigningCredentialGethKeychainPassword'", e);
                    }
    ...
    public Web3SigningCredential(Web3SigningCredentialCactiKeychainRef o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public Web3SigningCredential(Web3SigningCredentialGethKeychainPassword o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    static {
        schemas.put("Web3SigningCredentialCactiKeychainRef", new GenericType<Web3SigningCredentialCactiKeychainRef>() {
        });
        schemas.put("Web3SigningCredentialGethKeychainPassword", new GenericType<Web3SigningCredentialGethKeychainPassword>() {
        });
     ...
     * Web3SigningCredentialCactiKeychainRef, Web3SigningCredentialGethKeychainPassword, Web3SigningCredentialNone, Web3SigningCredentialPrivateKeyHex
     *
    ...
    public void setActualInstance(Object instance) {
        if (instance instanceof Web3SigningCredentialCactiKeychainRef) {
            super.setActualInstance(instance);
            return;
        }

        if (instance instanceof Web3SigningCredentialGethKeychainPassword) {
            super.setActualInstance(instance);
            return;
        }
        ...
        throw new RuntimeException("Invalid instance type. Must be Web3SigningCredentialCactiKeychainRef, Web3SigningCredentialGethKeychainPassword, Web3SigningCredentialNone, Web3SigningCredentialPrivateKeyHex");
    }
     ...
     * Web3SigningCredentialCactiKeychainRef, Web3SigningCredentialGethKeychainPassword, Web3SigningCredentialNone, Web3SigningCredentialPrivateKeyHex
     *
     * @return The actual instance (Web3SigningCredentialCactiKeychainRef, Web3SigningCredentialGethKeychainPassword, Web3SigningCredentialNone, Web3SigningCredentialPrivateKeyHex)
     */
    @Override
    ...
    /**
     * Get the actual instance of `Web3SigningCredentialCactiKeychainRef`. If the actual instance is not `Web3SigningCredentialCactiKeychainRef`,
     * the ClassCastException will be thrown.
     *
     * @return The actual instance of `Web3SigningCredentialCactiKeychainRef`
     * @throws ClassCastException if the instance is not `Web3SigningCredentialCactiKeychainRef`
     */
    public Web3SigningCredentialCactiKeychainRef getWeb3SigningCredentialCactiKeychainRef() throws ClassCastException {
        return (Web3SigningCredentialCactiKeychainRef)super.getActualInstance();
    }

    /**
     * Get the actual instance of `Web3SigningCredentialGethKeychainPassword`. If the actual instance is not `Web3SigningCredentialGethKeychainPassword`,
     * the ClassCastException will be thrown.
     *
     * @return The actual instance of `Web3SigningCredentialGethKeychainPassword`
     * @throws ClassCastException if the instance is not `Web3SigningCredentialGethKeychainPassword`
     */
    public Web3SigningCredentialGethKeychainPassword getWeb3SigningCredentialGethKeychainPassword() throws ClassCastException {
        return (Web3SigningCredentialGethKeychainPassword)super.getActualInstance();
    }
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
    ...
    int validCount = 0;
    ArrayList<String> errorMessages = new ArrayList<>();
    // validate the json string with Web3SigningCredentialCactiKeychainRef
    try {
      Web3SigningCredentialCactiKeychainRef.validateJsonObject(jsonObj);
      validCount++;
    } catch (Exception e) {
      errorMessages.add(String.format("Deserialization for Web3SigningCredentialCactiKeychainRef failed with `%s`.", e.getMessage()));
      // continue to the next one
    }
    // validate the json string with Web3SigningCredentialGethKeychainPassword
    try {
      Web3SigningCredentialGethKeychainPassword.validateJsonObject(jsonObj);
      validCount++;
    } catch (Exception e) {
      errorMessages.add(String.format("Deserialization for Web3SigningCredentialGethKeychainPassword failed with `%s`.", e.getMessage()));
      // continue to the next one
