...
public class Web3BlockHeader {
  ...
  public Web3BlockHeader number(String number) {
  ...
  **/
  ...
  public Web3BlockHeader gasLimit(String gasLimit) {
  ...
  **/
  ...
  public Web3BlockHeader gasUsed(String gasUsed) {
  ...
  **/
  ...
  public Web3BlockHeader timestamp(String timestamp) {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(number, parentHash, sha3Uncles, transactionsRoot, receiptsRoot, difficulty, mixHash, miner, gasLimit, gasUsed, stateRoot, logsBloom, extraData, nonce, timestamp);
  }
