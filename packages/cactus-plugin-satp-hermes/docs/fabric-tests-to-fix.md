...
image (`ghcr.io/hyperledger-cacti/cactus-fabric2-all-in-one:v3.0.0-beta.1`) suffer
...
| **Docker image** | `ghcr.io/hyperledger-cacti/cactus-fabric2-all-in-one:v3.0.0-beta.1` |
