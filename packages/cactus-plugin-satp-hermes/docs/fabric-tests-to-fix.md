...
image (`ghcr.io/hyperledger-cacti/cactus-fabric2-all-in-one:v3.0.0-alpha.7`) suffer
...
| **Docker image** | `ghcr.io/hyperledger-cacti/cactus-fabric2-all-in-one:v3.0.0-alpha.7` |
