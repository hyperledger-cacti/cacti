...
import { RollbackStrategyFactory } from "../../../../main/typescript/core/recovery/rollback/rollback-strategy-factory";
import { Stage0RollbackStrategy } from "../../../../main/typescript/core/recovery/rollback/stage0-rollback-strategy";
import { Stage1RollbackStrategy } from "../../../../main/typescript/core/recovery/rollback/stage1-rollback-strategy";
import { Stage2RollbackStrategy } from "../../../../main/typescript/core/recovery/rollback/stage2-rollback-strategy";
import { Stage3RollbackStrategy } from "../../../../main/typescript/core/recovery/rollback/stage3-rollback-strategy";
import { ILocalLogRepository } from "../../../../main/typescript/repository/interfaces/repository";
import { ISATPBridgesOptions } from "../../../../main/typescript/gol/satp-bridges-manager";
...
describe("RollbackStrategyFactory Tests", () => {
  ...
  it("should create Stage1RollbackStrategy when stage2 hashes are present", () => {
    const mockSession = createMockSession("1000", "3");
    const sessionData = mockSession.getClientSessionData();
    sessionData.hashes = new MessageStagesHashes();
