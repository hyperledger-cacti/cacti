...
beforeAll(async () => {
  ...
  {
    const satpContractName = "satp-contract-nft";
  ...
  {
    const erc20TokenContract = "SATPContractNFT";
...
describe("2 SATPGateways sending a token from Besu to Fabric", () => {
  ...
  it("should mint a single non-fungible tokens to the owner account", async () => {
    await besuEnv.mintTokens("100"); //TODO: Something different
