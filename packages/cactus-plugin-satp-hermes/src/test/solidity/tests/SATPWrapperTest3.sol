...
contract SATPWrapperTest is Test{
    ...
    address public whaleAddr = makeAddr("whaleAddr");
    ...
    function setUp() public {
        ...
        contract1 = new SATPNFTokenContract(whaleAddr);
    ...
    function testWrap() public {
        wrapperContract.wrap(contract1.name(), address(contract1), TokenType.NONSTANDARD_FUNGIBLE, contract1.name(), "refID", address(whaleAddr), signatures);
    ...
    function testLock() public {
        ...
        wrapperContract.wrap(contract1.name(), address(contract1), TokenType.NONSTANDARD_NONFUNGIBLE, contract1.name(), "refID", address(whaleAddr), signatures);
        contract1.mint(address(whaleAddr), 1001);
