...
contract SATPWrapperTest is Test{
    ...
    function testWrap() public {
        wrapperContract.wrap(contract1.name(), address(contract1), TokenType.FUNGIBLE, contract1.name(), "refID", address(user), signatures, ERCTokenStandard.ERC20);
    ...
    function testWrapTokenAlreadyWrapped() public {
        ...
        try wrapperContract.wrap(contract1.name(), address(contract1), TokenType.FUNGIBLE, contract1.name(), "refID", address(user), signatures, ERCTokenStandard.ERC20) returns (bool s) {
