...
// checks if the ApiV1HyperledgerCactusPluginSatpHermesOracleRegisterPostRequestOperationsInnerContract type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ApiV1HyperledgerCactusPluginSatpHermesOracleRegisterPostRequestOperationsInnerContract{}

// ApiV1HyperledgerCactusPluginSatpHermesOracleRegisterPostRequestOperationsInnerContract The contract associated with the Oracle operation.
type ApiV1HyperledgerCactusPluginSatpHermesOracleRegisterPostRequestOperationsInnerContract struct {
...
func NewApiV1HyperledgerCactusPluginSatpHermesOracleRegisterPostRequestOperationsInnerContract() *ApiV1HyperledgerCactusPluginSatpHermesOracleRegisterPostRequestOperationsInnerContract {
	this := ApiV1HyperledgerCactusPluginSatpHermesOracleRegisterPostRequestOperationsInnerContract{}
	return &this
}
...
func (o *ApiV1HyperledgerCactusPluginSatpHermesOracleRegisterPostRequestOperationsInnerContract) SetContractAddressNil() {
...
func (o *ApiV1HyperledgerCactusPluginSatpHermesOracleRegisterPostRequestOperationsInnerContract) SetContractBytecodeNil() {
...
func (o ApiV1HyperledgerCactusPluginSatpHermesOracleRegisterPostRequestOperationsInnerContract) MarshalJSON() ([]byte, error) {
...
func (o ApiV1HyperledgerCactusPluginSatpHermesOracleRegisterPostRequestOperationsInnerContract) ToMap() (map[string]interface{}, error) {
...
type NullableApiV1HyperledgerCactusPluginSatpHermesOracleRegisterPostRequestOperationsInnerContract struct {
	value *ApiV1HyperledgerCactusPluginSatpHermesOracleRegisterPostRequestOperationsInnerContract
	isSet bool
}

func (v NullableApiV1HyperledgerCactusPluginSatpHermesOracleRegisterPostRequestOperationsInnerContract) Get() *ApiV1HyperledgerCactusPluginSatpHermesOracleRegisterPostRequestOperationsInnerContract {
	return v.value
}

func (v *NullableApiV1HyperledgerCactusPluginSatpHermesOracleRegisterPostRequestOperationsInnerContract) Set(val *ApiV1HyperledgerCactusPluginSatpHermesOracleRegisterPostRequestOperationsInnerContract) {
	v.value = val
	v.isSet = true
}

func (v NullableApiV1HyperledgerCactusPluginSatpHermesOracleRegisterPostRequestOperationsInnerContract) IsSet() bool {
	return v.isSet
}

func (v *NullableApiV1HyperledgerCactusPluginSatpHermesOracleRegisterPostRequestOperationsInnerContract) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableApiV1HyperledgerCactusPluginSatpHermesOracleRegisterPostRequestOperationsInnerContract(val *ApiV1HyperledgerCactusPluginSatpHermesOracleRegisterPostRequestOperationsInnerContract) *NullableApiV1HyperledgerCactusPluginSatpHermesOracleRegisterPostRequestOperationsInnerContract {
	return &NullableApiV1HyperledgerCactusPluginSatpHermesOracleRegisterPostRequestOperationsInnerContract{value: val, isSet: true}
}

func (v NullableApiV1HyperledgerCactusPluginSatpHermesOracleRegisterPostRequestOperationsInnerContract) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableApiV1HyperledgerCactusPluginSatpHermesOracleRegisterPostRequestOperationsInnerContract) UnmarshalJSON(src []byte) error {
	v.isSet = true
