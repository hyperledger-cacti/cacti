...
// checks if the OracleExecuteRequestDestinationContract type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &OracleExecuteRequestDestinationContract{}

// OracleExecuteRequestDestinationContract The contract data on the destination blockchain. Only if taskType is UPDATE or READ_AND_UPDATE.
type OracleExecuteRequestDestinationContract struct {
...
func NewOracleExecuteRequestDestinationContract() *OracleExecuteRequestDestinationContract {
	this := OracleExecuteRequestDestinationContract{}
	return &this
}
...
func (o *OracleExecuteRequestDestinationContract) SetContractAddressNil() {
...
func (o *OracleExecuteRequestDestinationContract) SetContractBytecodeNil() {
...
func (o OracleExecuteRequestDestinationContract) MarshalJSON() ([]byte, error) {
...
func (o OracleExecuteRequestDestinationContract) ToMap() (map[string]interface{}, error) {
...
type NullableOracleExecuteRequestDestinationContract struct {
	value *OracleExecuteRequestDestinationContract
	isSet bool
}

func (v NullableOracleExecuteRequestDestinationContract) Get() *OracleExecuteRequestDestinationContract {
	return v.value
}

func (v *NullableOracleExecuteRequestDestinationContract) Set(val *OracleExecuteRequestDestinationContract) {
	v.value = val
	v.isSet = true
}

func (v NullableOracleExecuteRequestDestinationContract) IsSet() bool {
	return v.isSet
}

func (v *NullableOracleExecuteRequestDestinationContract) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableOracleExecuteRequestDestinationContract(val *OracleExecuteRequestDestinationContract) *NullableOracleExecuteRequestDestinationContract {
	return &NullableOracleExecuteRequestDestinationContract{value: val, isSet: true}
}

func (v NullableOracleExecuteRequestDestinationContract) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableOracleExecuteRequestDestinationContract) UnmarshalJSON(src []byte) error {
	v.isSet = true
