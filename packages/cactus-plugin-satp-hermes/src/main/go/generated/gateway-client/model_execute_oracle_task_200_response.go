...
// checks if the ExecuteOracleTask200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ExecuteOracleTask200Response{}

// ExecuteOracleTask200Response Response schema for executing a data transfer task. Includes the task ID and status of the execution.
type ExecuteOracleTask200Response struct {
...
func NewExecuteOracleTask200Response(type_ string, srcContract ExecuteOracleTask200ResponseSrcContract, dstContract ExecuteOracleTask200ResponseDstContract, timestamp int64, operations []ExecuteOracleTask200ResponseOperationsInner, status string, mode string) *ExecuteOracleTask200Response {
	this := ExecuteOracleTask200Response{}
	this.Type = type_
...
func (o ExecuteOracleTask200Response) MarshalJSON() ([]byte, error) {
...
func (o ExecuteOracleTask200Response) ToMap() (map[string]interface{}, error) {
...
type NullableExecuteOracleTask200Response struct {
	value *ExecuteOracleTask200Response
	isSet bool
}

func (v NullableExecuteOracleTask200Response) Get() *ExecuteOracleTask200Response {
	return v.value
}

func (v *NullableExecuteOracleTask200Response) Set(val *ExecuteOracleTask200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableExecuteOracleTask200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableExecuteOracleTask200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableExecuteOracleTask200Response(val *ExecuteOracleTask200Response) *NullableExecuteOracleTask200Response {
	return &NullableExecuteOracleTask200Response{value: val, isSet: true}
}

func (v NullableExecuteOracleTask200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableExecuteOracleTask200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
