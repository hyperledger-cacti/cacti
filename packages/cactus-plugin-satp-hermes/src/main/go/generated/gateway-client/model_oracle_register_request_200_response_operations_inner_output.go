...
// checks if the OracleRegisterRequest200ResponseOperationsInnerOutput type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &OracleRegisterRequest200ResponseOperationsInnerOutput{}

// OracleRegisterRequest200ResponseOperationsInnerOutput Optional output generated by the Oracle operation.
type OracleRegisterRequest200ResponseOperationsInnerOutput struct {
...
func NewOracleRegisterRequest200ResponseOperationsInnerOutput() *OracleRegisterRequest200ResponseOperationsInnerOutput {
	this := OracleRegisterRequest200ResponseOperationsInnerOutput{}
	return &this
}
...
func (o OracleRegisterRequest200ResponseOperationsInnerOutput) MarshalJSON() ([]byte, error) {
...
func (o OracleRegisterRequest200ResponseOperationsInnerOutput) ToMap() (map[string]interface{}, error) {
...
type NullableOracleRegisterRequest200ResponseOperationsInnerOutput struct {
	value *OracleRegisterRequest200ResponseOperationsInnerOutput
	isSet bool
}

func (v NullableOracleRegisterRequest200ResponseOperationsInnerOutput) Get() *OracleRegisterRequest200ResponseOperationsInnerOutput {
	return v.value
}

func (v *NullableOracleRegisterRequest200ResponseOperationsInnerOutput) Set(val *OracleRegisterRequest200ResponseOperationsInnerOutput) {
	v.value = val
	v.isSet = true
}

func (v NullableOracleRegisterRequest200ResponseOperationsInnerOutput) IsSet() bool {
	return v.isSet
}

func (v *NullableOracleRegisterRequest200ResponseOperationsInnerOutput) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableOracleRegisterRequest200ResponseOperationsInnerOutput(val *OracleRegisterRequest200ResponseOperationsInnerOutput) *NullableOracleRegisterRequest200ResponseOperationsInnerOutput {
	return &NullableOracleRegisterRequest200ResponseOperationsInnerOutput{value: val, isSet: true}
}

func (v NullableOracleRegisterRequest200ResponseOperationsInnerOutput) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableOracleRegisterRequest200ResponseOperationsInnerOutput) UnmarshalJSON(src []byte) error {
	v.isSet = true
