...
// checks if the ExecuteOracleTask200ResponseAllOfDstContract type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ExecuteOracleTask200ResponseAllOfDstContract{}

// ExecuteOracleTask200ResponseAllOfDstContract The destination contract details for the Oracle task.
type ExecuteOracleTask200ResponseAllOfDstContract struct {
...
func NewExecuteOracleTask200ResponseAllOfDstContract() *ExecuteOracleTask200ResponseAllOfDstContract {
	this := ExecuteOracleTask200ResponseAllOfDstContract{}
	return &this
}
...
func (o *ExecuteOracleTask200ResponseAllOfDstContract) SetContractAddressNil() {
...
func (o *ExecuteOracleTask200ResponseAllOfDstContract) SetContractBytecodeNil() {
...
func (o ExecuteOracleTask200ResponseAllOfDstContract) MarshalJSON() ([]byte, error) {
...
func (o ExecuteOracleTask200ResponseAllOfDstContract) ToMap() (map[string]interface{}, error) {
...
type NullableExecuteOracleTask200ResponseAllOfDstContract struct {
	value *ExecuteOracleTask200ResponseAllOfDstContract
	isSet bool
}

func (v NullableExecuteOracleTask200ResponseAllOfDstContract) Get() *ExecuteOracleTask200ResponseAllOfDstContract {
	return v.value
}

func (v *NullableExecuteOracleTask200ResponseAllOfDstContract) Set(val *ExecuteOracleTask200ResponseAllOfDstContract) {
	v.value = val
	v.isSet = true
}

func (v NullableExecuteOracleTask200ResponseAllOfDstContract) IsSet() bool {
	return v.isSet
}

func (v *NullableExecuteOracleTask200ResponseAllOfDstContract) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableExecuteOracleTask200ResponseAllOfDstContract(val *ExecuteOracleTask200ResponseAllOfDstContract) *NullableExecuteOracleTask200ResponseAllOfDstContract {
	return &NullableExecuteOracleTask200ResponseAllOfDstContract{value: val, isSet: true}
}

func (v NullableExecuteOracleTask200ResponseAllOfDstContract) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableExecuteOracleTask200ResponseAllOfDstContract) UnmarshalJSON(src []byte) error {
	v.isSet = true
