...
// checks if the RegisterOracleTask200ResponseAllOfOperationsInnerContract type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RegisterOracleTask200ResponseAllOfOperationsInnerContract{}

// RegisterOracleTask200ResponseAllOfOperationsInnerContract The contract associated with the Oracle operation.
type RegisterOracleTask200ResponseAllOfOperationsInnerContract struct {
...
func NewRegisterOracleTask200ResponseAllOfOperationsInnerContract() *RegisterOracleTask200ResponseAllOfOperationsInnerContract {
	this := RegisterOracleTask200ResponseAllOfOperationsInnerContract{}
	return &this
}
...
func (o *RegisterOracleTask200ResponseAllOfOperationsInnerContract) SetContractAddressNil() {
...
func (o *RegisterOracleTask200ResponseAllOfOperationsInnerContract) SetContractBytecodeNil() {
...
func (o RegisterOracleTask200ResponseAllOfOperationsInnerContract) MarshalJSON() ([]byte, error) {
...
func (o RegisterOracleTask200ResponseAllOfOperationsInnerContract) ToMap() (map[string]interface{}, error) {
...
type NullableRegisterOracleTask200ResponseAllOfOperationsInnerContract struct {
	value *RegisterOracleTask200ResponseAllOfOperationsInnerContract
	isSet bool
}

func (v NullableRegisterOracleTask200ResponseAllOfOperationsInnerContract) Get() *RegisterOracleTask200ResponseAllOfOperationsInnerContract {
	return v.value
}

func (v *NullableRegisterOracleTask200ResponseAllOfOperationsInnerContract) Set(val *RegisterOracleTask200ResponseAllOfOperationsInnerContract) {
	v.value = val
	v.isSet = true
}

func (v NullableRegisterOracleTask200ResponseAllOfOperationsInnerContract) IsSet() bool {
	return v.isSet
}

func (v *NullableRegisterOracleTask200ResponseAllOfOperationsInnerContract) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRegisterOracleTask200ResponseAllOfOperationsInnerContract(val *RegisterOracleTask200ResponseAllOfOperationsInnerContract) *NullableRegisterOracleTask200ResponseAllOfOperationsInnerContract {
	return &NullableRegisterOracleTask200ResponseAllOfOperationsInnerContract{value: val, isSet: true}
}

func (v NullableRegisterOracleTask200ResponseAllOfOperationsInnerContract) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRegisterOracleTask200ResponseAllOfOperationsInnerContract) UnmarshalJSON(src []byte) error {
	v.isSet = true
