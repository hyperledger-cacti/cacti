...
// checks if the OracleStatusRequest200ResponseWriteFunction type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &OracleStatusRequest200ResponseWriteFunction{}

// OracleStatusRequest200ResponseWriteFunction Details about the write function in the destination contract for the data transfer task.
type OracleStatusRequest200ResponseWriteFunction struct {
...
func NewOracleStatusRequest200ResponseWriteFunction() *OracleStatusRequest200ResponseWriteFunction {
	this := OracleStatusRequest200ResponseWriteFunction{}
	return &this
}
...
func (o OracleStatusRequest200ResponseWriteFunction) MarshalJSON() ([]byte, error) {
...
func (o OracleStatusRequest200ResponseWriteFunction) ToMap() (map[string]interface{}, error) {
...
type NullableOracleStatusRequest200ResponseWriteFunction struct {
	value *OracleStatusRequest200ResponseWriteFunction
	isSet bool
}

func (v NullableOracleStatusRequest200ResponseWriteFunction) Get() *OracleStatusRequest200ResponseWriteFunction {
	return v.value
}

func (v *NullableOracleStatusRequest200ResponseWriteFunction) Set(val *OracleStatusRequest200ResponseWriteFunction) {
	v.value = val
	v.isSet = true
}

func (v NullableOracleStatusRequest200ResponseWriteFunction) IsSet() bool {
	return v.isSet
}

func (v *NullableOracleStatusRequest200ResponseWriteFunction) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableOracleStatusRequest200ResponseWriteFunction(val *OracleStatusRequest200ResponseWriteFunction) *NullableOracleStatusRequest200ResponseWriteFunction {
	return &NullableOracleStatusRequest200ResponseWriteFunction{value: val, isSet: true}
}

func (v NullableOracleStatusRequest200ResponseWriteFunction) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableOracleStatusRequest200ResponseWriteFunction) UnmarshalJSON(src []byte) error {
	v.isSet = true
