...
// checks if the TransactRequestSourceAssetNetworkId type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &TransactRequestSourceAssetNetworkId{}

// TransactRequestSourceAssetNetworkId The network of the DLT being interacted with.
type TransactRequestSourceAssetNetworkId struct {
...
func NewTransactRequestSourceAssetNetworkId(id string, ledgerType string) *TransactRequestSourceAssetNetworkId {
	this := TransactRequestSourceAssetNetworkId{}
	this.Id = id
...
func (o TransactRequestSourceAssetNetworkId) MarshalJSON() ([]byte, error) {
...
func (o TransactRequestSourceAssetNetworkId) ToMap() (map[string]interface{}, error) {
...
type NullableTransactRequestSourceAssetNetworkId struct {
	value *TransactRequestSourceAssetNetworkId
	isSet bool
}

func (v NullableTransactRequestSourceAssetNetworkId) Get() *TransactRequestSourceAssetNetworkId {
	return v.value
}

func (v *NullableTransactRequestSourceAssetNetworkId) Set(val *TransactRequestSourceAssetNetworkId) {
	v.value = val
	v.isSet = true
}

func (v NullableTransactRequestSourceAssetNetworkId) IsSet() bool {
	return v.isSet
}

func (v *NullableTransactRequestSourceAssetNetworkId) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableTransactRequestSourceAssetNetworkId(val *TransactRequestSourceAssetNetworkId) *NullableTransactRequestSourceAssetNetworkId {
	return &NullableTransactRequestSourceAssetNetworkId{value: val, isSet: true}
}

func (v NullableTransactRequestSourceAssetNetworkId) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableTransactRequestSourceAssetNetworkId) UnmarshalJSON(src []byte) error {
	v.isSet = true
