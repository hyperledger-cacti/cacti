...
// checks if the DraftVersions type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DraftVersions{}

// DraftVersions The draft versions supported by the gateway.
type DraftVersions struct {
...
func (o DraftVersions) MarshalJSON() ([]byte, error) {
...
func (o DraftVersions) ToMap() (map[string]interface{}, error) {
...
type NullableDraftVersions struct {
	value *DraftVersions
	isSet bool
}

func (v NullableDraftVersions) Get() *DraftVersions {
	return v.value
}

func (v *NullableDraftVersions) Set(val *DraftVersions) {
	v.value = val
	v.isSet = true
}

func (v NullableDraftVersions) IsSet() bool {
	return v.isSet
}

func (v *NullableDraftVersions) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDraftVersions(val *DraftVersions) *NullableDraftVersions {
	return &NullableDraftVersions{value: val, isSet: true}
}

func (v NullableDraftVersions) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDraftVersions) UnmarshalJSON(src []byte) error {
	v.isSet = true
