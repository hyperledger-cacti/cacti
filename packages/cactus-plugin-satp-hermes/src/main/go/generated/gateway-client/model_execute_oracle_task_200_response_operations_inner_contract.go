...
// checks if the ExecuteOracleTask200ResponseOperationsInnerContract type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ExecuteOracleTask200ResponseOperationsInnerContract{}

// ExecuteOracleTask200ResponseOperationsInnerContract The contract associated with the Oracle operation.
type ExecuteOracleTask200ResponseOperationsInnerContract struct {
...
func NewExecuteOracleTask200ResponseOperationsInnerContract() *ExecuteOracleTask200ResponseOperationsInnerContract {
	this := ExecuteOracleTask200ResponseOperationsInnerContract{}
	return &this
}
...
func (o *ExecuteOracleTask200ResponseOperationsInnerContract) SetContractAddressNil() {
...
func (o *ExecuteOracleTask200ResponseOperationsInnerContract) SetContractBytecodeNil() {
...
func (o ExecuteOracleTask200ResponseOperationsInnerContract) MarshalJSON() ([]byte, error) {
...
func (o ExecuteOracleTask200ResponseOperationsInnerContract) ToMap() (map[string]interface{}, error) {
...
type NullableExecuteOracleTask200ResponseOperationsInnerContract struct {
	value *ExecuteOracleTask200ResponseOperationsInnerContract
	isSet bool
}

func (v NullableExecuteOracleTask200ResponseOperationsInnerContract) Get() *ExecuteOracleTask200ResponseOperationsInnerContract {
	return v.value
}

func (v *NullableExecuteOracleTask200ResponseOperationsInnerContract) Set(val *ExecuteOracleTask200ResponseOperationsInnerContract) {
	v.value = val
	v.isSet = true
}

func (v NullableExecuteOracleTask200ResponseOperationsInnerContract) IsSet() bool {
	return v.isSet
}

func (v *NullableExecuteOracleTask200ResponseOperationsInnerContract) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableExecuteOracleTask200ResponseOperationsInnerContract(val *ExecuteOracleTask200ResponseOperationsInnerContract) *NullableExecuteOracleTask200ResponseOperationsInnerContract {
	return &NullableExecuteOracleTask200ResponseOperationsInnerContract{value: val, isSet: true}
}

func (v NullableExecuteOracleTask200ResponseOperationsInnerContract) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableExecuteOracleTask200ResponseOperationsInnerContract) UnmarshalJSON(src []byte) error {
	v.isSet = true
