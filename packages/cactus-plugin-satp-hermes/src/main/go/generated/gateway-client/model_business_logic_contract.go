...
// checks if the BusinessLogicContract type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &BusinessLogicContract{}

// BusinessLogicContract Represents a business logic contract with its associated metadata and method details.
type BusinessLogicContract struct {
...
func (o *BusinessLogicContract) SetContractAddressNil() {
...
func (o *BusinessLogicContract) SetContractBytecodeNil() {
...
func (o BusinessLogicContract) MarshalJSON() ([]byte, error) {
...
func (o BusinessLogicContract) ToMap() (map[string]interface{}, error) {
...
type NullableBusinessLogicContract struct {
	value *BusinessLogicContract
	isSet bool
}

func (v NullableBusinessLogicContract) Get() *BusinessLogicContract {
	return v.value
}

func (v *NullableBusinessLogicContract) Set(val *BusinessLogicContract) {
	v.value = val
	v.isSet = true
}

func (v NullableBusinessLogicContract) IsSet() bool {
	return v.isSet
}

func (v *NullableBusinessLogicContract) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableBusinessLogicContract(val *BusinessLogicContract) *NullableBusinessLogicContract {
	return &NullableBusinessLogicContract{value: val, isSet: true}
}

func (v NullableBusinessLogicContract) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableBusinessLogicContract) UnmarshalJSON(src []byte) error {
	v.isSet = true
