...
// checks if the RegisterOracleTask200ResponseOperationsInnerContract type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RegisterOracleTask200ResponseOperationsInnerContract{}

// RegisterOracleTask200ResponseOperationsInnerContract The contract associated with the Oracle operation.
type RegisterOracleTask200ResponseOperationsInnerContract struct {
...
func NewRegisterOracleTask200ResponseOperationsInnerContract() *RegisterOracleTask200ResponseOperationsInnerContract {
	this := RegisterOracleTask200ResponseOperationsInnerContract{}
	return &this
}
...
func (o *RegisterOracleTask200ResponseOperationsInnerContract) SetContractAddressNil() {
...
func (o *RegisterOracleTask200ResponseOperationsInnerContract) SetContractBytecodeNil() {
...
func (o RegisterOracleTask200ResponseOperationsInnerContract) MarshalJSON() ([]byte, error) {
...
func (o RegisterOracleTask200ResponseOperationsInnerContract) ToMap() (map[string]interface{}, error) {
...
type NullableRegisterOracleTask200ResponseOperationsInnerContract struct {
	value *RegisterOracleTask200ResponseOperationsInnerContract
	isSet bool
}

func (v NullableRegisterOracleTask200ResponseOperationsInnerContract) Get() *RegisterOracleTask200ResponseOperationsInnerContract {
	return v.value
}

func (v *NullableRegisterOracleTask200ResponseOperationsInnerContract) Set(val *RegisterOracleTask200ResponseOperationsInnerContract) {
	v.value = val
	v.isSet = true
}

func (v NullableRegisterOracleTask200ResponseOperationsInnerContract) IsSet() bool {
	return v.isSet
}

func (v *NullableRegisterOracleTask200ResponseOperationsInnerContract) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRegisterOracleTask200ResponseOperationsInnerContract(val *RegisterOracleTask200ResponseOperationsInnerContract) *NullableRegisterOracleTask200ResponseOperationsInnerContract {
	return &NullableRegisterOracleTask200ResponseOperationsInnerContract{value: val, isSet: true}
}

func (v NullableRegisterOracleTask200ResponseOperationsInnerContract) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRegisterOracleTask200ResponseOperationsInnerContract) UnmarshalJSON(src []byte) error {
	v.isSet = true
