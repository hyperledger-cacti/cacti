...
// checks if the OracleRepeatableTaskAllOfOutput type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &OracleRepeatableTaskAllOfOutput{}

// OracleRepeatableTaskAllOfOutput Optional output generated by the Oracle operation.
type OracleRepeatableTaskAllOfOutput struct {
...
func NewOracleRepeatableTaskAllOfOutput() *OracleRepeatableTaskAllOfOutput {
	this := OracleRepeatableTaskAllOfOutput{}
	return &this
}
...
func (o OracleRepeatableTaskAllOfOutput) MarshalJSON() ([]byte, error) {
...
func (o OracleRepeatableTaskAllOfOutput) ToMap() (map[string]interface{}, error) {
...
type NullableOracleRepeatableTaskAllOfOutput struct {
	value *OracleRepeatableTaskAllOfOutput
	isSet bool
}

func (v NullableOracleRepeatableTaskAllOfOutput) Get() *OracleRepeatableTaskAllOfOutput {
	return v.value
}

func (v *NullableOracleRepeatableTaskAllOfOutput) Set(val *OracleRepeatableTaskAllOfOutput) {
	v.value = val
	v.isSet = true
}

func (v NullableOracleRepeatableTaskAllOfOutput) IsSet() bool {
	return v.isSet
}

func (v *NullableOracleRepeatableTaskAllOfOutput) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableOracleRepeatableTaskAllOfOutput(val *OracleRepeatableTaskAllOfOutput) *NullableOracleRepeatableTaskAllOfOutput {
	return &NullableOracleRepeatableTaskAllOfOutput{value: val, isSet: true}
}

func (v NullableOracleRepeatableTaskAllOfOutput) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableOracleRepeatableTaskAllOfOutput) UnmarshalJSON(src []byte) error {
	v.isSet = true
