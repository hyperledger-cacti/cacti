...
// checks if the OracleRegisterRequest200ResponseSrcContract type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &OracleRegisterRequest200ResponseSrcContract{}

// OracleRegisterRequest200ResponseSrcContract The source contract details for the Oracle task.
type OracleRegisterRequest200ResponseSrcContract struct {
...
func NewOracleRegisterRequest200ResponseSrcContract() *OracleRegisterRequest200ResponseSrcContract {
	this := OracleRegisterRequest200ResponseSrcContract{}
	return &this
}
...
func (o *OracleRegisterRequest200ResponseSrcContract) SetContractAddressNil() {
...
func (o *OracleRegisterRequest200ResponseSrcContract) SetContractBytecodeNil() {
...
func (o OracleRegisterRequest200ResponseSrcContract) MarshalJSON() ([]byte, error) {
...
func (o OracleRegisterRequest200ResponseSrcContract) ToMap() (map[string]interface{}, error) {
...
type NullableOracleRegisterRequest200ResponseSrcContract struct {
	value *OracleRegisterRequest200ResponseSrcContract
	isSet bool
}

func (v NullableOracleRegisterRequest200ResponseSrcContract) Get() *OracleRegisterRequest200ResponseSrcContract {
	return v.value
}

func (v *NullableOracleRegisterRequest200ResponseSrcContract) Set(val *OracleRegisterRequest200ResponseSrcContract) {
	v.value = val
	v.isSet = true
}

func (v NullableOracleRegisterRequest200ResponseSrcContract) IsSet() bool {
	return v.isSet
}

func (v *NullableOracleRegisterRequest200ResponseSrcContract) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableOracleRegisterRequest200ResponseSrcContract(val *OracleRegisterRequest200ResponseSrcContract) *NullableOracleRegisterRequest200ResponseSrcContract {
	return &NullableOracleRegisterRequest200ResponseSrcContract{value: val, isSet: true}
}

func (v NullableOracleRegisterRequest200ResponseSrcContract) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableOracleRegisterRequest200ResponseSrcContract) UnmarshalJSON(src []byte) error {
	v.isSet = true
