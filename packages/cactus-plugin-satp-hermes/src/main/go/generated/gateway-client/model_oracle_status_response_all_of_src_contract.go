...
// checks if the OracleStatusResponseAllOfSrcContract type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &OracleStatusResponseAllOfSrcContract{}

// OracleStatusResponseAllOfSrcContract The source contract details for the Oracle task.
type OracleStatusResponseAllOfSrcContract struct {
...
func NewOracleStatusResponseAllOfSrcContract() *OracleStatusResponseAllOfSrcContract {
	this := OracleStatusResponseAllOfSrcContract{}
	return &this
}
...
func (o *OracleStatusResponseAllOfSrcContract) SetContractAddressNil() {
...
func (o *OracleStatusResponseAllOfSrcContract) SetContractBytecodeNil() {
...
func (o OracleStatusResponseAllOfSrcContract) MarshalJSON() ([]byte, error) {
...
func (o OracleStatusResponseAllOfSrcContract) ToMap() (map[string]interface{}, error) {
...
type NullableOracleStatusResponseAllOfSrcContract struct {
	value *OracleStatusResponseAllOfSrcContract
	isSet bool
}

func (v NullableOracleStatusResponseAllOfSrcContract) Get() *OracleStatusResponseAllOfSrcContract {
	return v.value
}

func (v *NullableOracleStatusResponseAllOfSrcContract) Set(val *OracleStatusResponseAllOfSrcContract) {
	v.value = val
	v.isSet = true
}

func (v NullableOracleStatusResponseAllOfSrcContract) IsSet() bool {
	return v.isSet
}

func (v *NullableOracleStatusResponseAllOfSrcContract) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableOracleStatusResponseAllOfSrcContract(val *OracleStatusResponseAllOfSrcContract) *NullableOracleStatusResponseAllOfSrcContract {
	return &NullableOracleStatusResponseAllOfSrcContract{value: val, isSet: true}
}

func (v NullableOracleStatusResponseAllOfSrcContract) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableOracleStatusResponseAllOfSrcContract) UnmarshalJSON(src []byte) error {
	v.isSet = true
