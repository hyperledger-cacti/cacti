...
// checks if the GetTaskStatus200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetTaskStatus200Response{}

// GetTaskStatus200Response Response schema for checking the status of a data transfer task. Includes the task ID and status of the task.
...
func (o GetTaskStatus200Response) MarshalJSON() ([]byte, error) {
...
func (o GetTaskStatus200Response) ToMap() (map[string]interface{}, error) {
...
type NullableGetTaskStatus200Response struct {
	value *GetTaskStatus200Response
	isSet bool
}

func (v NullableGetTaskStatus200Response) Get() *GetTaskStatus200Response {
	return v.value
}

func (v *NullableGetTaskStatus200Response) Set(val *GetTaskStatus200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableGetTaskStatus200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableGetTaskStatus200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetTaskStatus200Response(val *GetTaskStatus200Response) *NullableGetTaskStatus200Response {
	return &NullableGetTaskStatus200Response{value: val, isSet: true}
}

func (v NullableGetTaskStatus200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetTaskStatus200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
