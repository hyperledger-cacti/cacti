...
// checks if the ExecuteOracleTaskRequestDestinationContract type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ExecuteOracleTaskRequestDestinationContract{}

// ExecuteOracleTaskRequestDestinationContract The contract data on the destination blockchain. Only if taskType is UPDATE or READ_AND_UPDATE.
type ExecuteOracleTaskRequestDestinationContract struct {
...
func NewExecuteOracleTaskRequestDestinationContract() *ExecuteOracleTaskRequestDestinationContract {
	this := ExecuteOracleTaskRequestDestinationContract{}
	return &this
}
...
func (o *ExecuteOracleTaskRequestDestinationContract) SetContractAddressNil() {
...
func (o *ExecuteOracleTaskRequestDestinationContract) SetContractBytecodeNil() {
...
func (o ExecuteOracleTaskRequestDestinationContract) MarshalJSON() ([]byte, error) {
...
func (o ExecuteOracleTaskRequestDestinationContract) ToMap() (map[string]interface{}, error) {
...
type NullableExecuteOracleTaskRequestDestinationContract struct {
	value *ExecuteOracleTaskRequestDestinationContract
	isSet bool
}

func (v NullableExecuteOracleTaskRequestDestinationContract) Get() *ExecuteOracleTaskRequestDestinationContract {
	return v.value
}

func (v *NullableExecuteOracleTaskRequestDestinationContract) Set(val *ExecuteOracleTaskRequestDestinationContract) {
	v.value = val
	v.isSet = true
}

func (v NullableExecuteOracleTaskRequestDestinationContract) IsSet() bool {
	return v.isSet
}

func (v *NullableExecuteOracleTaskRequestDestinationContract) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableExecuteOracleTaskRequestDestinationContract(val *ExecuteOracleTaskRequestDestinationContract) *NullableExecuteOracleTaskRequestDestinationContract {
	return &NullableExecuteOracleTaskRequestDestinationContract{value: val, isSet: true}
}

func (v NullableExecuteOracleTaskRequestDestinationContract) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableExecuteOracleTaskRequestDestinationContract) UnmarshalJSON(src []byte) error {
	v.isSet = true
