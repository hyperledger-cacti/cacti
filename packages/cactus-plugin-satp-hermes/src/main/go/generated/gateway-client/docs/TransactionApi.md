...
func main() {
    transactRequest := *openapiclient.NewTransactRequest("123e4567-e89b-12d3-a456-426614174000", "transfer", "network1", "network2", "100", "TOKEN1", "95", "TOKEN2", "BeneficiaryPubkey_example", "OriginatorPubkey_example") // TransactRequest | 
