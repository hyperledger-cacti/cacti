...
// checks if the OracleStatusResponseAllOfSrcNetworkId type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &OracleStatusResponseAllOfSrcNetworkId{}

// OracleStatusResponseAllOfSrcNetworkId The network of the DLT being interacted with.
type OracleStatusResponseAllOfSrcNetworkId struct {
...
func NewOracleStatusResponseAllOfSrcNetworkId(id string, ledgerType string) *OracleStatusResponseAllOfSrcNetworkId {
	this := OracleStatusResponseAllOfSrcNetworkId{}
	this.Id = id
...
func (o OracleStatusResponseAllOfSrcNetworkId) MarshalJSON() ([]byte, error) {
...
func (o OracleStatusResponseAllOfSrcNetworkId) ToMap() (map[string]interface{}, error) {
...
type NullableOracleStatusResponseAllOfSrcNetworkId struct {
	value *OracleStatusResponseAllOfSrcNetworkId
	isSet bool
}

func (v NullableOracleStatusResponseAllOfSrcNetworkId) Get() *OracleStatusResponseAllOfSrcNetworkId {
	return v.value
}

func (v *NullableOracleStatusResponseAllOfSrcNetworkId) Set(val *OracleStatusResponseAllOfSrcNetworkId) {
	v.value = val
	v.isSet = true
}

func (v NullableOracleStatusResponseAllOfSrcNetworkId) IsSet() bool {
	return v.isSet
}

func (v *NullableOracleStatusResponseAllOfSrcNetworkId) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableOracleStatusResponseAllOfSrcNetworkId(val *OracleStatusResponseAllOfSrcNetworkId) *NullableOracleStatusResponseAllOfSrcNetworkId {
	return &NullableOracleStatusResponseAllOfSrcNetworkId{value: val, isSet: true}
}

func (v NullableOracleStatusResponseAllOfSrcNetworkId) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableOracleStatusResponseAllOfSrcNetworkId) UnmarshalJSON(src []byte) error {
	v.isSet = true
