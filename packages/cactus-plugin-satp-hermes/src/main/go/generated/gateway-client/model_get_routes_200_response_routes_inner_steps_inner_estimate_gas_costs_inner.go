...
// checks if the GetRoutes200ResponseRoutesInnerStepsInnerEstimateGasCostsInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetRoutes200ResponseRoutesInnerStepsInnerEstimateGasCostsInner{}

// GetRoutes200ResponseRoutesInnerStepsInnerEstimateGasCostsInner struct for GetRoutes200ResponseRoutesInnerStepsInnerEstimateGasCostsInner
type GetRoutes200ResponseRoutesInnerStepsInnerEstimateGasCostsInner struct {
...
func (o GetRoutes200ResponseRoutesInnerStepsInnerEstimateGasCostsInner) MarshalJSON() ([]byte, error) {
...
func (o GetRoutes200ResponseRoutesInnerStepsInnerEstimateGasCostsInner) ToMap() (map[string]interface{}, error) {
...
type NullableGetRoutes200ResponseRoutesInnerStepsInnerEstimateGasCostsInner struct {
	value *GetRoutes200ResponseRoutesInnerStepsInnerEstimateGasCostsInner
	isSet bool
}

func (v NullableGetRoutes200ResponseRoutesInnerStepsInnerEstimateGasCostsInner) Get() *GetRoutes200ResponseRoutesInnerStepsInnerEstimateGasCostsInner {
	return v.value
}

func (v *NullableGetRoutes200ResponseRoutesInnerStepsInnerEstimateGasCostsInner) Set(val *GetRoutes200ResponseRoutesInnerStepsInnerEstimateGasCostsInner) {
	v.value = val
	v.isSet = true
}

func (v NullableGetRoutes200ResponseRoutesInnerStepsInnerEstimateGasCostsInner) IsSet() bool {
	return v.isSet
}

func (v *NullableGetRoutes200ResponseRoutesInnerStepsInnerEstimateGasCostsInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetRoutes200ResponseRoutesInnerStepsInnerEstimateGasCostsInner(val *GetRoutes200ResponseRoutesInnerStepsInnerEstimateGasCostsInner) *NullableGetRoutes200ResponseRoutesInnerStepsInnerEstimateGasCostsInner {
	return &NullableGetRoutes200ResponseRoutesInnerStepsInnerEstimateGasCostsInner{value: val, isSet: true}
}

func (v NullableGetRoutes200ResponseRoutesInnerStepsInnerEstimateGasCostsInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetRoutes200ResponseRoutesInnerStepsInnerEstimateGasCostsInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
