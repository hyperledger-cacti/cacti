...
// checks if the OracleExecuteRequest200ResponseOperationsInnerOutput type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &OracleExecuteRequest200ResponseOperationsInnerOutput{}

// OracleExecuteRequest200ResponseOperationsInnerOutput Optional output generated by the Oracle operation.
type OracleExecuteRequest200ResponseOperationsInnerOutput struct {
...
func NewOracleExecuteRequest200ResponseOperationsInnerOutput() *OracleExecuteRequest200ResponseOperationsInnerOutput {
	this := OracleExecuteRequest200ResponseOperationsInnerOutput{}
	return &this
}
...
func (o OracleExecuteRequest200ResponseOperationsInnerOutput) MarshalJSON() ([]byte, error) {
...
func (o OracleExecuteRequest200ResponseOperationsInnerOutput) ToMap() (map[string]interface{}, error) {
...
type NullableOracleExecuteRequest200ResponseOperationsInnerOutput struct {
	value *OracleExecuteRequest200ResponseOperationsInnerOutput
	isSet bool
}

func (v NullableOracleExecuteRequest200ResponseOperationsInnerOutput) Get() *OracleExecuteRequest200ResponseOperationsInnerOutput {
	return v.value
}

func (v *NullableOracleExecuteRequest200ResponseOperationsInnerOutput) Set(val *OracleExecuteRequest200ResponseOperationsInnerOutput) {
	v.value = val
	v.isSet = true
}

func (v NullableOracleExecuteRequest200ResponseOperationsInnerOutput) IsSet() bool {
	return v.isSet
}

func (v *NullableOracleExecuteRequest200ResponseOperationsInnerOutput) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableOracleExecuteRequest200ResponseOperationsInnerOutput(val *OracleExecuteRequest200ResponseOperationsInnerOutput) *NullableOracleExecuteRequest200ResponseOperationsInnerOutput {
	return &NullableOracleExecuteRequest200ResponseOperationsInnerOutput{value: val, isSet: true}
}

func (v NullableOracleExecuteRequest200ResponseOperationsInnerOutput) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableOracleExecuteRequest200ResponseOperationsInnerOutput) UnmarshalJSON(src []byte) error {
	v.isSet = true
