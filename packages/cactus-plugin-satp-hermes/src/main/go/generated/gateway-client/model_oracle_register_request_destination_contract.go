...
type NullableOracleRegisterRequestDestinationContract struct {
	value *OracleRegisterRequestDestinationContract
	isSet bool
}

func (v NullableOracleRegisterRequestDestinationContract) Get() *OracleRegisterRequestDestinationContract {
	return v.value
}

func (v *NullableOracleRegisterRequestDestinationContract) Set(val *OracleRegisterRequestDestinationContract) {
	v.value = val
	v.isSet = true
}

func (v NullableOracleRegisterRequestDestinationContract) IsSet() bool {
	return v.isSet
}

func (v *NullableOracleRegisterRequestDestinationContract) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableOracleRegisterRequestDestinationContract(val *OracleRegisterRequestDestinationContract) *NullableOracleRegisterRequestDestinationContract {
	return &NullableOracleRegisterRequestDestinationContract{value: val, isSet: true}
}

func (v NullableOracleRegisterRequestDestinationContract) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableOracleRegisterRequestDestinationContract) UnmarshalJSON(src []byte) error {
	v.isSet = true
