...
// checks if the RegisterOracleTask200ResponseAllOfSrcContract type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RegisterOracleTask200ResponseAllOfSrcContract{}

// RegisterOracleTask200ResponseAllOfSrcContract The source contract details for the Oracle task.
type RegisterOracleTask200ResponseAllOfSrcContract struct {
...
func NewRegisterOracleTask200ResponseAllOfSrcContract() *RegisterOracleTask200ResponseAllOfSrcContract {
	this := RegisterOracleTask200ResponseAllOfSrcContract{}
	return &this
}
...
func (o *RegisterOracleTask200ResponseAllOfSrcContract) SetContractAddressNil() {
...
func (o *RegisterOracleTask200ResponseAllOfSrcContract) SetContractBytecodeNil() {
...
func (o RegisterOracleTask200ResponseAllOfSrcContract) MarshalJSON() ([]byte, error) {
...
func (o RegisterOracleTask200ResponseAllOfSrcContract) ToMap() (map[string]interface{}, error) {
...
type NullableRegisterOracleTask200ResponseAllOfSrcContract struct {
	value *RegisterOracleTask200ResponseAllOfSrcContract
	isSet bool
}

func (v NullableRegisterOracleTask200ResponseAllOfSrcContract) Get() *RegisterOracleTask200ResponseAllOfSrcContract {
	return v.value
}

func (v *NullableRegisterOracleTask200ResponseAllOfSrcContract) Set(val *RegisterOracleTask200ResponseAllOfSrcContract) {
	v.value = val
	v.isSet = true
}

func (v NullableRegisterOracleTask200ResponseAllOfSrcContract) IsSet() bool {
	return v.isSet
}

func (v *NullableRegisterOracleTask200ResponseAllOfSrcContract) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRegisterOracleTask200ResponseAllOfSrcContract(val *RegisterOracleTask200ResponseAllOfSrcContract) *NullableRegisterOracleTask200ResponseAllOfSrcContract {
	return &NullableRegisterOracleTask200ResponseAllOfSrcContract{value: val, isSet: true}
}

func (v NullableRegisterOracleTask200ResponseAllOfSrcContract) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRegisterOracleTask200ResponseAllOfSrcContract) UnmarshalJSON(src []byte) error {
	v.isSet = true
