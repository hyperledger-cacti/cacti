...
// checks if the RegisterOracleTask200ResponseAllOf type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RegisterOracleTask200ResponseAllOf{}

// RegisterOracleTask200ResponseAllOf Represents a repeatable Oracle task with additional properties for mode, polling interval, and source event signature.
type RegisterOracleTask200ResponseAllOf struct {
	...
	SrcContract RegisterOracleTask200ResponseAllOfSrcContract `json:"srcContract"`
	DstNetworkId *TransactRequestSourceAssetNetworkId `json:"dstNetworkId,omitempty"`
	DstContract RegisterOracleTask200ResponseAllOfDstContract `json:"dstContract"`
	// The timestamp when the Oracle task was created or last updated.
	Timestamp int64 `json:"timestamp"`
	// The list of operations performed by the Oracle task.
	Operations []RegisterOracleTask200ResponseAllOfOperationsInner `json:"operations"`
...
func NewRegisterOracleTask200ResponseAllOf(id string, type_ Enum, srcContract RegisterOracleTask200ResponseAllOfSrcContract, dstContract RegisterOracleTask200ResponseAllOfDstContract, timestamp int64, operations []RegisterOracleTask200ResponseAllOfOperationsInner, status Enum, mode string) *RegisterOracleTask200ResponseAllOf {
	this := RegisterOracleTask200ResponseAllOf{}
	this.Id = id
	this.Type = type_
...
func (o *RegisterOracleTask200ResponseAllOf) GetSrcContract() RegisterOracleTask200ResponseAllOfSrcContract {
	if o == nil {
		var ret RegisterOracleTask200ResponseAllOfSrcContract
		return ret
	}
...
func (o *RegisterOracleTask200ResponseAllOf) GetDstContract() RegisterOracleTask200ResponseAllOfDstContract {
	if o == nil {
		var ret RegisterOracleTask200ResponseAllOfDstContract
		return ret
	}
...
func (o *RegisterOracleTask200ResponseAllOf) GetOperations() []RegisterOracleTask200ResponseAllOfOperationsInner {
	if o == nil {
		var ret []RegisterOracleTask200ResponseAllOfOperationsInner
		return ret
	}
...
func (o RegisterOracleTask200ResponseAllOf) MarshalJSON() ([]byte, error) {
...
func (o RegisterOracleTask200ResponseAllOf) ToMap() (map[string]interface{}, error) {
...
type NullableRegisterOracleTask200ResponseAllOf struct {
	value *RegisterOracleTask200ResponseAllOf
	isSet bool
}

func (v NullableRegisterOracleTask200ResponseAllOf) Get() *RegisterOracleTask200ResponseAllOf {
	return v.value
}

func (v *NullableRegisterOracleTask200ResponseAllOf) Set(val *RegisterOracleTask200ResponseAllOf) {
	v.value = val
	v.isSet = true
}

func (v NullableRegisterOracleTask200ResponseAllOf) IsSet() bool {
	return v.isSet
}

func (v *NullableRegisterOracleTask200ResponseAllOf) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRegisterOracleTask200ResponseAllOf(val *RegisterOracleTask200ResponseAllOf) *NullableRegisterOracleTask200ResponseAllOf {
	return &NullableRegisterOracleTask200ResponseAllOf{value: val, isSet: true}
}

func (v NullableRegisterOracleTask200ResponseAllOf) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRegisterOracleTask200ResponseAllOf) UnmarshalJSON(src []byte) error {
	v.isSet = true
