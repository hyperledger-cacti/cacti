...
// checks if the OracleRegisterRequest200ResponseDstContract type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &OracleRegisterRequest200ResponseDstContract{}

// OracleRegisterRequest200ResponseDstContract The destination contract details for the Oracle task.
type OracleRegisterRequest200ResponseDstContract struct {
...
func NewOracleRegisterRequest200ResponseDstContract() *OracleRegisterRequest200ResponseDstContract {
	this := OracleRegisterRequest200ResponseDstContract{}
	return &this
}
...
func (o *OracleRegisterRequest200ResponseDstContract) SetContractAddressNil() {
...
func (o *OracleRegisterRequest200ResponseDstContract) SetContractBytecodeNil() {
...
func (o OracleRegisterRequest200ResponseDstContract) MarshalJSON() ([]byte, error) {
...
func (o OracleRegisterRequest200ResponseDstContract) ToMap() (map[string]interface{}, error) {
...
type NullableOracleRegisterRequest200ResponseDstContract struct {
	value *OracleRegisterRequest200ResponseDstContract
	isSet bool
}

func (v NullableOracleRegisterRequest200ResponseDstContract) Get() *OracleRegisterRequest200ResponseDstContract {
	return v.value
}

func (v *NullableOracleRegisterRequest200ResponseDstContract) Set(val *OracleRegisterRequest200ResponseDstContract) {
	v.value = val
	v.isSet = true
}

func (v NullableOracleRegisterRequest200ResponseDstContract) IsSet() bool {
	return v.isSet
}

func (v *NullableOracleRegisterRequest200ResponseDstContract) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableOracleRegisterRequest200ResponseDstContract(val *OracleRegisterRequest200ResponseDstContract) *NullableOracleRegisterRequest200ResponseDstContract {
	return &NullableOracleRegisterRequest200ResponseDstContract{value: val, isSet: true}
}

func (v NullableOracleRegisterRequest200ResponseDstContract) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableOracleRegisterRequest200ResponseDstContract) UnmarshalJSON(src []byte) error {
	v.isSet = true
