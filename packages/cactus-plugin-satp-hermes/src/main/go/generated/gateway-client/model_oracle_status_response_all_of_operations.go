...
// checks if the OracleStatusResponseAllOfOperations type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &OracleStatusResponseAllOfOperations{}

// OracleStatusResponseAllOfOperations Represents an operation performed by the Oracle, including its type, network, contract, status, and optional output.
type OracleStatusResponseAllOfOperations struct {
	// A unique identifier for the Oracle operation.
	Id string `json:"id"`
	// The type of the Oracle operation.
	Type string `json:"type"`
	NetworkId OracleStatusResponseAllOfSrcNetworkId `json:"networkId"`
	Contract OracleStatusResponseAllOfContract `json:"contract"`
	// The current status of the Oracle operation.
	Status string `json:"status"`
	Output *OracleStatusResponseAllOfOutput `json:"output,omitempty"`
...
func NewOracleStatusResponseAllOfOperations(id string, type_ string, networkId OracleStatusResponseAllOfSrcNetworkId, contract OracleStatusResponseAllOfContract, status string, timestamp int64) *OracleStatusResponseAllOfOperations {
	this := OracleStatusResponseAllOfOperations{}
	this.Id = id
	this.Type = type_
...
func (o *OracleStatusResponseAllOfOperations) GetContract() OracleStatusResponseAllOfContract {
	if o == nil {
		var ret OracleStatusResponseAllOfContract
		return ret
	}
...
func (o *OracleStatusResponseAllOfOperations) GetOutput() OracleStatusResponseAllOfOutput {
	if o == nil || IsNil(o.Output) {
		var ret OracleStatusResponseAllOfOutput
		return ret
	}
	return *o.Output
}
...
// SetOutput gets a reference to the given OracleStatusResponseAllOfOutput and assigns it to the Output field.
...
func (o OracleStatusResponseAllOfOperations) MarshalJSON() ([]byte, error) {
...
func (o OracleStatusResponseAllOfOperations) ToMap() (map[string]interface{}, error) {
...
type NullableOracleStatusResponseAllOfOperations struct {
	value *OracleStatusResponseAllOfOperations
	isSet bool
}

func (v NullableOracleStatusResponseAllOfOperations) Get() *OracleStatusResponseAllOfOperations {
	return v.value
}

func (v *NullableOracleStatusResponseAllOfOperations) Set(val *OracleStatusResponseAllOfOperations) {
	v.value = val
	v.isSet = true
}

func (v NullableOracleStatusResponseAllOfOperations) IsSet() bool {
	return v.isSet
}

func (v *NullableOracleStatusResponseAllOfOperations) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableOracleStatusResponseAllOfOperations(val *OracleStatusResponseAllOfOperations) *NullableOracleStatusResponseAllOfOperations {
	return &NullableOracleStatusResponseAllOfOperations{value: val, isSet: true}
}

func (v NullableOracleStatusResponseAllOfOperations) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableOracleStatusResponseAllOfOperations) UnmarshalJSON(src []byte) error {
	v.isSet = true
