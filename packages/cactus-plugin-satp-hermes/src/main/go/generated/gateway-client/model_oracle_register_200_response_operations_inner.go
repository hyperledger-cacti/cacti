...
// checks if the OracleRegister200ResponseOperationsInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &OracleRegister200ResponseOperationsInner{}

// OracleRegister200ResponseOperationsInner Represents an operation performed by the Oracle, including its type, network, contract, status, and optional output.
type OracleRegister200ResponseOperationsInner struct {
	...
	Contract OracleRegister200ResponseOperationsInnerContract `json:"contract"`
	// The current status of the Oracle operation.
	Status string `json:"status"`
	Output *OracleRegister200ResponseOperationsInnerOutput `json:"output,omitempty"`
...
func NewOracleRegister200ResponseOperationsInner(id string, type_ string, networkId TransactRequestSourceAssetNetworkId, contract OracleRegister200ResponseOperationsInnerContract, status string, timestamp int64) *OracleRegister200ResponseOperationsInner {
	this := OracleRegister200ResponseOperationsInner{}
	this.Id = id
	this.Type = type_
...
func (o *OracleRegister200ResponseOperationsInner) GetContract() OracleRegister200ResponseOperationsInnerContract {
	if o == nil {
		var ret OracleRegister200ResponseOperationsInnerContract
		return ret
	}
...
func (o *OracleRegister200ResponseOperationsInner) GetOutput() OracleRegister200ResponseOperationsInnerOutput {
	if o == nil || IsNil(o.Output) {
		var ret OracleRegister200ResponseOperationsInnerOutput
		return ret
	}
	return *o.Output
}
...
// SetOutput gets a reference to the given OracleRegister200ResponseOperationsInnerOutput and assigns it to the Output field.
...
func (o OracleRegister200ResponseOperationsInner) MarshalJSON() ([]byte, error) {
...
func (o OracleRegister200ResponseOperationsInner) ToMap() (map[string]interface{}, error) {
...
type NullableOracleRegister200ResponseOperationsInner struct {
	value *OracleRegister200ResponseOperationsInner
	isSet bool
}

func (v NullableOracleRegister200ResponseOperationsInner) Get() *OracleRegister200ResponseOperationsInner {
	return v.value
}

func (v *NullableOracleRegister200ResponseOperationsInner) Set(val *OracleRegister200ResponseOperationsInner) {
	v.value = val
	v.isSet = true
}

func (v NullableOracleRegister200ResponseOperationsInner) IsSet() bool {
	return v.isSet
}

func (v *NullableOracleRegister200ResponseOperationsInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableOracleRegister200ResponseOperationsInner(val *OracleRegister200ResponseOperationsInner) *NullableOracleRegister200ResponseOperationsInner {
	return &NullableOracleRegister200ResponseOperationsInner{value: val, isSet: true}
}

func (v NullableOracleRegister200ResponseOperationsInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableOracleRegister200ResponseOperationsInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
