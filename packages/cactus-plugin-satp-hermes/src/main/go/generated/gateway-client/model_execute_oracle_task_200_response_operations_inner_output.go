...
// checks if the ExecuteOracleTask200ResponseOperationsInnerOutput type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ExecuteOracleTask200ResponseOperationsInnerOutput{}

// ExecuteOracleTask200ResponseOperationsInnerOutput Optional output generated by the Oracle operation.
type ExecuteOracleTask200ResponseOperationsInnerOutput struct {
...
func NewExecuteOracleTask200ResponseOperationsInnerOutput() *ExecuteOracleTask200ResponseOperationsInnerOutput {
	this := ExecuteOracleTask200ResponseOperationsInnerOutput{}
	return &this
}
...
func (o ExecuteOracleTask200ResponseOperationsInnerOutput) MarshalJSON() ([]byte, error) {
...
func (o ExecuteOracleTask200ResponseOperationsInnerOutput) ToMap() (map[string]interface{}, error) {
...
type NullableExecuteOracleTask200ResponseOperationsInnerOutput struct {
	value *ExecuteOracleTask200ResponseOperationsInnerOutput
	isSet bool
}

func (v NullableExecuteOracleTask200ResponseOperationsInnerOutput) Get() *ExecuteOracleTask200ResponseOperationsInnerOutput {
	return v.value
}

func (v *NullableExecuteOracleTask200ResponseOperationsInnerOutput) Set(val *ExecuteOracleTask200ResponseOperationsInnerOutput) {
	v.value = val
	v.isSet = true
}

func (v NullableExecuteOracleTask200ResponseOperationsInnerOutput) IsSet() bool {
	return v.isSet
}

func (v *NullableExecuteOracleTask200ResponseOperationsInnerOutput) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableExecuteOracleTask200ResponseOperationsInnerOutput(val *ExecuteOracleTask200ResponseOperationsInnerOutput) *NullableExecuteOracleTask200ResponseOperationsInnerOutput {
	return &NullableExecuteOracleTask200ResponseOperationsInnerOutput{value: val, isSet: true}
}

func (v NullableExecuteOracleTask200ResponseOperationsInnerOutput) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableExecuteOracleTask200ResponseOperationsInnerOutput) UnmarshalJSON(src []byte) error {
	v.isSet = true
