...
// checks if the OracleOperation type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &OracleOperation{}

// OracleOperation Represents an operation performed by the Oracle, including its type, network, contract, status, and optional output.
...
func (o OracleOperation) MarshalJSON() ([]byte, error) {
...
func (o OracleOperation) ToMap() (map[string]interface{}, error) {
...
type NullableOracleOperation struct {
	value *OracleOperation
	isSet bool
}

func (v NullableOracleOperation) Get() *OracleOperation {
	return v.value
}

func (v *NullableOracleOperation) Set(val *OracleOperation) {
	v.value = val
	v.isSet = true
}

func (v NullableOracleOperation) IsSet() bool {
	return v.isSet
}

func (v *NullableOracleOperation) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableOracleOperation(val *OracleOperation) *NullableOracleOperation {
	return &NullableOracleOperation{value: val, isSet: true}
}

func (v NullableOracleOperation) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableOracleOperation) UnmarshalJSON(src []byte) error {
	v.isSet = true
