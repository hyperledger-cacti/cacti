...
// checks if the OracleRegisterRequestWriteFunction type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &OracleRegisterRequestWriteFunction{}

// OracleRegisterRequestWriteFunction Details about the write function in the destination contract for the data transfer task.
type OracleRegisterRequestWriteFunction struct {
...
func NewOracleRegisterRequestWriteFunction() *OracleRegisterRequestWriteFunction {
	this := OracleRegisterRequestWriteFunction{}
	return &this
}
...
func (o OracleRegisterRequestWriteFunction) MarshalJSON() ([]byte, error) {
...
func (o OracleRegisterRequestWriteFunction) ToMap() (map[string]interface{}, error) {
...
type NullableOracleRegisterRequestWriteFunction struct {
	value *OracleRegisterRequestWriteFunction
	isSet bool
}

func (v NullableOracleRegisterRequestWriteFunction) Get() *OracleRegisterRequestWriteFunction {
	return v.value
}

func (v *NullableOracleRegisterRequestWriteFunction) Set(val *OracleRegisterRequestWriteFunction) {
	v.value = val
	v.isSet = true
}

func (v NullableOracleRegisterRequestWriteFunction) IsSet() bool {
	return v.isSet
}

func (v *NullableOracleRegisterRequestWriteFunction) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableOracleRegisterRequestWriteFunction(val *OracleRegisterRequestWriteFunction) *NullableOracleRegisterRequestWriteFunction {
	return &NullableOracleRegisterRequestWriteFunction{value: val, isSet: true}
}

func (v NullableOracleRegisterRequestWriteFunction) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableOracleRegisterRequestWriteFunction) UnmarshalJSON(src []byte) error {
	v.isSet = true
