...
// checks if the OracleRegisterRequest200ResponseOperationsInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &OracleRegisterRequest200ResponseOperationsInner{}

// OracleRegisterRequest200ResponseOperationsInner Represents an operation performed by the Oracle, including its type, network, contract, status, and optional output.
type OracleRegisterRequest200ResponseOperationsInner struct {
	...
	Contract OracleRegisterRequest200ResponseOperationsInnerContract `json:"contract"`
	// The current status of the Oracle operation.
	Status string `json:"status"`
	Output *OracleRegisterRequest200ResponseOperationsInnerOutput `json:"output,omitempty"`
...
func NewOracleRegisterRequest200ResponseOperationsInner(id string, type_ string, networkId TransactRequestSourceAssetNetworkId, contract OracleRegisterRequest200ResponseOperationsInnerContract, status string, timestamp int64) *OracleRegisterRequest200ResponseOperationsInner {
	this := OracleRegisterRequest200ResponseOperationsInner{}
	this.Id = id
	this.Type = type_
...
func (o *OracleRegisterRequest200ResponseOperationsInner) GetContract() OracleRegisterRequest200ResponseOperationsInnerContract {
	if o == nil {
		var ret OracleRegisterRequest200ResponseOperationsInnerContract
		return ret
	}
...
func (o *OracleRegisterRequest200ResponseOperationsInner) GetOutput() OracleRegisterRequest200ResponseOperationsInnerOutput {
	if o == nil || IsNil(o.Output) {
		var ret OracleRegisterRequest200ResponseOperationsInnerOutput
		return ret
	}
	return *o.Output
}
...
// SetOutput gets a reference to the given OracleRegisterRequest200ResponseOperationsInnerOutput and assigns it to the Output field.
...
func (o OracleRegisterRequest200ResponseOperationsInner) MarshalJSON() ([]byte, error) {
...
func (o OracleRegisterRequest200ResponseOperationsInner) ToMap() (map[string]interface{}, error) {
...
type NullableOracleRegisterRequest200ResponseOperationsInner struct {
	value *OracleRegisterRequest200ResponseOperationsInner
	isSet bool
}

func (v NullableOracleRegisterRequest200ResponseOperationsInner) Get() *OracleRegisterRequest200ResponseOperationsInner {
	return v.value
}

func (v *NullableOracleRegisterRequest200ResponseOperationsInner) Set(val *OracleRegisterRequest200ResponseOperationsInner) {
	v.value = val
	v.isSet = true
}

func (v NullableOracleRegisterRequest200ResponseOperationsInner) IsSet() bool {
	return v.isSet
}

func (v *NullableOracleRegisterRequest200ResponseOperationsInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableOracleRegisterRequest200ResponseOperationsInner(val *OracleRegisterRequest200ResponseOperationsInner) *NullableOracleRegisterRequest200ResponseOperationsInner {
	return &NullableOracleRegisterRequest200ResponseOperationsInner{value: val, isSet: true}
}

func (v NullableOracleRegisterRequest200ResponseOperationsInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableOracleRegisterRequest200ResponseOperationsInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
