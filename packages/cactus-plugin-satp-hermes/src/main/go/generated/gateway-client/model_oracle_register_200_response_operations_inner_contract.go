...
// checks if the OracleRegister200ResponseOperationsInnerContract type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &OracleRegister200ResponseOperationsInnerContract{}

// OracleRegister200ResponseOperationsInnerContract The contract associated with the Oracle operation.
type OracleRegister200ResponseOperationsInnerContract struct {
...
func NewOracleRegister200ResponseOperationsInnerContract() *OracleRegister200ResponseOperationsInnerContract {
	this := OracleRegister200ResponseOperationsInnerContract{}
	return &this
}
...
func (o *OracleRegister200ResponseOperationsInnerContract) SetContractAddressNil() {
...
func (o *OracleRegister200ResponseOperationsInnerContract) SetContractBytecodeNil() {
...
func (o OracleRegister200ResponseOperationsInnerContract) MarshalJSON() ([]byte, error) {
...
func (o OracleRegister200ResponseOperationsInnerContract) ToMap() (map[string]interface{}, error) {
...
type NullableOracleRegister200ResponseOperationsInnerContract struct {
	value *OracleRegister200ResponseOperationsInnerContract
	isSet bool
}

func (v NullableOracleRegister200ResponseOperationsInnerContract) Get() *OracleRegister200ResponseOperationsInnerContract {
	return v.value
}

func (v *NullableOracleRegister200ResponseOperationsInnerContract) Set(val *OracleRegister200ResponseOperationsInnerContract) {
	v.value = val
	v.isSet = true
}

func (v NullableOracleRegister200ResponseOperationsInnerContract) IsSet() bool {
	return v.isSet
}

func (v *NullableOracleRegister200ResponseOperationsInnerContract) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableOracleRegister200ResponseOperationsInnerContract(val *OracleRegister200ResponseOperationsInnerContract) *NullableOracleRegister200ResponseOperationsInnerContract {
	return &NullableOracleRegister200ResponseOperationsInnerContract{value: val, isSet: true}
}

func (v NullableOracleRegister200ResponseOperationsInnerContract) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableOracleRegister200ResponseOperationsInnerContract) UnmarshalJSON(src []byte) error {
	v.isSet = true
