...
// checks if the RegisterOracleTask200ResponseOperationsInnerOutput type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RegisterOracleTask200ResponseOperationsInnerOutput{}

// RegisterOracleTask200ResponseOperationsInnerOutput Optional output generated by the Oracle operation.
type RegisterOracleTask200ResponseOperationsInnerOutput struct {
...
func NewRegisterOracleTask200ResponseOperationsInnerOutput() *RegisterOracleTask200ResponseOperationsInnerOutput {
	this := RegisterOracleTask200ResponseOperationsInnerOutput{}
	return &this
}
...
func (o RegisterOracleTask200ResponseOperationsInnerOutput) MarshalJSON() ([]byte, error) {
...
func (o RegisterOracleTask200ResponseOperationsInnerOutput) ToMap() (map[string]interface{}, error) {
...
type NullableRegisterOracleTask200ResponseOperationsInnerOutput struct {
	value *RegisterOracleTask200ResponseOperationsInnerOutput
	isSet bool
}

func (v NullableRegisterOracleTask200ResponseOperationsInnerOutput) Get() *RegisterOracleTask200ResponseOperationsInnerOutput {
	return v.value
}

func (v *NullableRegisterOracleTask200ResponseOperationsInnerOutput) Set(val *RegisterOracleTask200ResponseOperationsInnerOutput) {
	v.value = val
	v.isSet = true
}

func (v NullableRegisterOracleTask200ResponseOperationsInnerOutput) IsSet() bool {
	return v.isSet
}

func (v *NullableRegisterOracleTask200ResponseOperationsInnerOutput) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRegisterOracleTask200ResponseOperationsInnerOutput(val *RegisterOracleTask200ResponseOperationsInnerOutput) *NullableRegisterOracleTask200ResponseOperationsInnerOutput {
	return &NullableRegisterOracleTask200ResponseOperationsInnerOutput{value: val, isSet: true}
}

func (v NullableRegisterOracleTask200ResponseOperationsInnerOutput) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRegisterOracleTask200ResponseOperationsInnerOutput) UnmarshalJSON(src []byte) error {
	v.isSet = true
