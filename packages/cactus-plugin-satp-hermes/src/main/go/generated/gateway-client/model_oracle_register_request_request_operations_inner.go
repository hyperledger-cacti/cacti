...
// checks if the OracleRegisterRequestRequestOperationsInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &OracleRegisterRequestRequestOperationsInner{}

// OracleRegisterRequestRequestOperationsInner Represents an operation performed by the Oracle, including its type, network, contract, status, and optional output.
type OracleRegisterRequestRequestOperationsInner struct {
	...
	Contract OracleRegisterRequestRequestOperationsInnerContract `json:"contract"`
	// The current status of the Oracle operation.
	Status string `json:"status"`
	Output *OracleRegisterRequestRequestOperationsInnerOutput `json:"output,omitempty"`
...
func NewOracleRegisterRequestRequestOperationsInner(id string, type_ string, networkId TransactRequestSourceAssetNetworkId, contract OracleRegisterRequestRequestOperationsInnerContract, status string, timestamp int64) *OracleRegisterRequestRequestOperationsInner {
	this := OracleRegisterRequestRequestOperationsInner{}
	this.Id = id
	this.Type = type_
...
func (o *OracleRegisterRequestRequestOperationsInner) GetContract() OracleRegisterRequestRequestOperationsInnerContract {
	if o == nil {
		var ret OracleRegisterRequestRequestOperationsInnerContract
		return ret
	}
...
func (o *OracleRegisterRequestRequestOperationsInner) GetOutput() OracleRegisterRequestRequestOperationsInnerOutput {
	if o == nil || IsNil(o.Output) {
		var ret OracleRegisterRequestRequestOperationsInnerOutput
		return ret
	}
	return *o.Output
}
...
// SetOutput gets a reference to the given OracleRegisterRequestRequestOperationsInnerOutput and assigns it to the Output field.
...
func (o OracleRegisterRequestRequestOperationsInner) MarshalJSON() ([]byte, error) {
...
func (o OracleRegisterRequestRequestOperationsInner) ToMap() (map[string]interface{}, error) {
...
type NullableOracleRegisterRequestRequestOperationsInner struct {
	value *OracleRegisterRequestRequestOperationsInner
	isSet bool
}

func (v NullableOracleRegisterRequestRequestOperationsInner) Get() *OracleRegisterRequestRequestOperationsInner {
	return v.value
}

func (v *NullableOracleRegisterRequestRequestOperationsInner) Set(val *OracleRegisterRequestRequestOperationsInner) {
	v.value = val
	v.isSet = true
}

func (v NullableOracleRegisterRequestRequestOperationsInner) IsSet() bool {
	return v.isSet
}

func (v *NullableOracleRegisterRequestRequestOperationsInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableOracleRegisterRequestRequestOperationsInner(val *OracleRegisterRequestRequestOperationsInner) *NullableOracleRegisterRequestRequestOperationsInner {
	return &NullableOracleRegisterRequestRequestOperationsInner{value: val, isSet: true}
}

func (v NullableOracleRegisterRequestRequestOperationsInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableOracleRegisterRequestRequestOperationsInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
