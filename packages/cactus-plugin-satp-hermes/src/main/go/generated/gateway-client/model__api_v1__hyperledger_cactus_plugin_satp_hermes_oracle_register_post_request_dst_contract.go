...
// checks if the ApiV1HyperledgerCactusPluginSatpHermesOracleRegisterPostRequestDstContract type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ApiV1HyperledgerCactusPluginSatpHermesOracleRegisterPostRequestDstContract{}

// ApiV1HyperledgerCactusPluginSatpHermesOracleRegisterPostRequestDstContract The destination contract details for the Oracle task.
type ApiV1HyperledgerCactusPluginSatpHermesOracleRegisterPostRequestDstContract struct {
...
func NewApiV1HyperledgerCactusPluginSatpHermesOracleRegisterPostRequestDstContract() *ApiV1HyperledgerCactusPluginSatpHermesOracleRegisterPostRequestDstContract {
	this := ApiV1HyperledgerCactusPluginSatpHermesOracleRegisterPostRequestDstContract{}
	return &this
}
...
func (o *ApiV1HyperledgerCactusPluginSatpHermesOracleRegisterPostRequestDstContract) SetContractAddressNil() {
...
func (o *ApiV1HyperledgerCactusPluginSatpHermesOracleRegisterPostRequestDstContract) SetContractBytecodeNil() {
...
func (o ApiV1HyperledgerCactusPluginSatpHermesOracleRegisterPostRequestDstContract) MarshalJSON() ([]byte, error) {
...
func (o ApiV1HyperledgerCactusPluginSatpHermesOracleRegisterPostRequestDstContract) ToMap() (map[string]interface{}, error) {
...
type NullableApiV1HyperledgerCactusPluginSatpHermesOracleRegisterPostRequestDstContract struct {
	value *ApiV1HyperledgerCactusPluginSatpHermesOracleRegisterPostRequestDstContract
	isSet bool
}

func (v NullableApiV1HyperledgerCactusPluginSatpHermesOracleRegisterPostRequestDstContract) Get() *ApiV1HyperledgerCactusPluginSatpHermesOracleRegisterPostRequestDstContract {
	return v.value
}

func (v *NullableApiV1HyperledgerCactusPluginSatpHermesOracleRegisterPostRequestDstContract) Set(val *ApiV1HyperledgerCactusPluginSatpHermesOracleRegisterPostRequestDstContract) {
	v.value = val
	v.isSet = true
}

func (v NullableApiV1HyperledgerCactusPluginSatpHermesOracleRegisterPostRequestDstContract) IsSet() bool {
	return v.isSet
}

func (v *NullableApiV1HyperledgerCactusPluginSatpHermesOracleRegisterPostRequestDstContract) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableApiV1HyperledgerCactusPluginSatpHermesOracleRegisterPostRequestDstContract(val *ApiV1HyperledgerCactusPluginSatpHermesOracleRegisterPostRequestDstContract) *NullableApiV1HyperledgerCactusPluginSatpHermesOracleRegisterPostRequestDstContract {
	return &NullableApiV1HyperledgerCactusPluginSatpHermesOracleRegisterPostRequestDstContract{value: val, isSet: true}
}

func (v NullableApiV1HyperledgerCactusPluginSatpHermesOracleRegisterPostRequestDstContract) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableApiV1HyperledgerCactusPluginSatpHermesOracleRegisterPostRequestDstContract) UnmarshalJSON(src []byte) error {
	v.isSet = true
