...
// checks if the OracleExecuteRequest200ResponseDstContract type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &OracleExecuteRequest200ResponseDstContract{}

// OracleExecuteRequest200ResponseDstContract The destination contract details for the Oracle task.
type OracleExecuteRequest200ResponseDstContract struct {
...
func NewOracleExecuteRequest200ResponseDstContract(contractName string, methodName string, params []OracleRegisterRequestRequestSourceContractParamsInner) *OracleExecuteRequest200ResponseDstContract {
	this := OracleExecuteRequest200ResponseDstContract{}
...
func (o *OracleExecuteRequest200ResponseDstContract) SetContractAddressNil() {
...
func (o *OracleExecuteRequest200ResponseDstContract) SetContractBytecodeNil() {
...
func (o *OracleExecuteRequest200ResponseDstContract) SetEventSignatureNil() {
...
func (o OracleExecuteRequest200ResponseDstContract) MarshalJSON() ([]byte, error) {
...
func (o OracleExecuteRequest200ResponseDstContract) ToMap() (map[string]interface{}, error) {
...
type NullableOracleExecuteRequest200ResponseDstContract struct {
	value *OracleExecuteRequest200ResponseDstContract
	isSet bool
}

func (v NullableOracleExecuteRequest200ResponseDstContract) Get() *OracleExecuteRequest200ResponseDstContract {
	return v.value
}

func (v *NullableOracleExecuteRequest200ResponseDstContract) Set(val *OracleExecuteRequest200ResponseDstContract) {
	v.value = val
	v.isSet = true
}

func (v NullableOracleExecuteRequest200ResponseDstContract) IsSet() bool {
	return v.isSet
}

func (v *NullableOracleExecuteRequest200ResponseDstContract) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableOracleExecuteRequest200ResponseDstContract(val *OracleExecuteRequest200ResponseDstContract) *NullableOracleExecuteRequest200ResponseDstContract {
	return &NullableOracleExecuteRequest200ResponseDstContract{value: val, isSet: true}
}

func (v NullableOracleExecuteRequest200ResponseDstContract) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableOracleExecuteRequest200ResponseDstContract) UnmarshalJSON(src []byte) error {
	v.isSet = true
