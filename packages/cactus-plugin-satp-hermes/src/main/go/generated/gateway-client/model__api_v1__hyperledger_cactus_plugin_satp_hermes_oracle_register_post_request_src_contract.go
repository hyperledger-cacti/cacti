...
// checks if the ApiV1HyperledgerCactusPluginSatpHermesOracleRegisterPostRequestSrcContract type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ApiV1HyperledgerCactusPluginSatpHermesOracleRegisterPostRequestSrcContract{}

// ApiV1HyperledgerCactusPluginSatpHermesOracleRegisterPostRequestSrcContract The source contract details for the Oracle task.
type ApiV1HyperledgerCactusPluginSatpHermesOracleRegisterPostRequestSrcContract struct {
...
func NewApiV1HyperledgerCactusPluginSatpHermesOracleRegisterPostRequestSrcContract() *ApiV1HyperledgerCactusPluginSatpHermesOracleRegisterPostRequestSrcContract {
	this := ApiV1HyperledgerCactusPluginSatpHermesOracleRegisterPostRequestSrcContract{}
	return &this
}
...
func (o *ApiV1HyperledgerCactusPluginSatpHermesOracleRegisterPostRequestSrcContract) SetContractAddressNil() {
...
func (o *ApiV1HyperledgerCactusPluginSatpHermesOracleRegisterPostRequestSrcContract) SetContractBytecodeNil() {
...
func (o ApiV1HyperledgerCactusPluginSatpHermesOracleRegisterPostRequestSrcContract) MarshalJSON() ([]byte, error) {
...
func (o ApiV1HyperledgerCactusPluginSatpHermesOracleRegisterPostRequestSrcContract) ToMap() (map[string]interface{}, error) {
...
type NullableApiV1HyperledgerCactusPluginSatpHermesOracleRegisterPostRequestSrcContract struct {
	value *ApiV1HyperledgerCactusPluginSatpHermesOracleRegisterPostRequestSrcContract
	isSet bool
}

func (v NullableApiV1HyperledgerCactusPluginSatpHermesOracleRegisterPostRequestSrcContract) Get() *ApiV1HyperledgerCactusPluginSatpHermesOracleRegisterPostRequestSrcContract {
	return v.value
}

func (v *NullableApiV1HyperledgerCactusPluginSatpHermesOracleRegisterPostRequestSrcContract) Set(val *ApiV1HyperledgerCactusPluginSatpHermesOracleRegisterPostRequestSrcContract) {
	v.value = val
	v.isSet = true
}

func (v NullableApiV1HyperledgerCactusPluginSatpHermesOracleRegisterPostRequestSrcContract) IsSet() bool {
	return v.isSet
}

func (v *NullableApiV1HyperledgerCactusPluginSatpHermesOracleRegisterPostRequestSrcContract) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableApiV1HyperledgerCactusPluginSatpHermesOracleRegisterPostRequestSrcContract(val *ApiV1HyperledgerCactusPluginSatpHermesOracleRegisterPostRequestSrcContract) *NullableApiV1HyperledgerCactusPluginSatpHermesOracleRegisterPostRequestSrcContract {
	return &NullableApiV1HyperledgerCactusPluginSatpHermesOracleRegisterPostRequestSrcContract{value: val, isSet: true}
}

func (v NullableApiV1HyperledgerCactusPluginSatpHermesOracleRegisterPostRequestSrcContract) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableApiV1HyperledgerCactusPluginSatpHermesOracleRegisterPostRequestSrcContract) UnmarshalJSON(src []byte) error {
	v.isSet = true
