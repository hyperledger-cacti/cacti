...
// checks if the GetRoutes200ResponseRoutesInnerStepsInnerAction type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetRoutes200ResponseRoutesInnerStepsInnerAction{}
...
func NewGetRoutes200ResponseRoutesInnerStepsInnerAction() *GetRoutes200ResponseRoutesInnerStepsInnerAction {
	this := GetRoutes200ResponseRoutesInnerStepsInnerAction{}
	return &this
}
...
func (o GetRoutes200ResponseRoutesInnerStepsInnerAction) MarshalJSON() ([]byte, error) {
...
func (o GetRoutes200ResponseRoutesInnerStepsInnerAction) ToMap() (map[string]interface{}, error) {
...
type NullableGetRoutes200ResponseRoutesInnerStepsInnerAction struct {
	value *GetRoutes200ResponseRoutesInnerStepsInnerAction
	isSet bool
}

func (v NullableGetRoutes200ResponseRoutesInnerStepsInnerAction) Get() *GetRoutes200ResponseRoutesInnerStepsInnerAction {
	return v.value
}

func (v *NullableGetRoutes200ResponseRoutesInnerStepsInnerAction) Set(val *GetRoutes200ResponseRoutesInnerStepsInnerAction) {
	v.value = val
	v.isSet = true
}

func (v NullableGetRoutes200ResponseRoutesInnerStepsInnerAction) IsSet() bool {
	return v.isSet
}

func (v *NullableGetRoutes200ResponseRoutesInnerStepsInnerAction) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetRoutes200ResponseRoutesInnerStepsInnerAction(val *GetRoutes200ResponseRoutesInnerStepsInnerAction) *NullableGetRoutes200ResponseRoutesInnerStepsInnerAction {
	return &NullableGetRoutes200ResponseRoutesInnerStepsInnerAction{value: val, isSet: true}
}

func (v NullableGetRoutes200ResponseRoutesInnerStepsInnerAction) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetRoutes200ResponseRoutesInnerStepsInnerAction) UnmarshalJSON(src []byte) error {
	v.isSet = true
