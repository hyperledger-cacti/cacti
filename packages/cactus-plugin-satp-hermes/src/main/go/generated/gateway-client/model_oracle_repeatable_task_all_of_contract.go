...
// checks if the OracleRepeatableTaskAllOfContract type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &OracleRepeatableTaskAllOfContract{}

// OracleRepeatableTaskAllOfContract The contract associated with the Oracle operation.
type OracleRepeatableTaskAllOfContract struct {
...
func NewOracleRepeatableTaskAllOfContract(contractName string, methodName string, params []OneOfstringnumber) *OracleRepeatableTaskAllOfContract {
	this := OracleRepeatableTaskAllOfContract{}
...
func (o *OracleRepeatableTaskAllOfContract) SetContractAddressNil() {
...
func (o *OracleRepeatableTaskAllOfContract) SetContractBytecodeNil() {
...
func (o OracleRepeatableTaskAllOfContract) MarshalJSON() ([]byte, error) {
...
func (o OracleRepeatableTaskAllOfContract) ToMap() (map[string]interface{}, error) {
...
type NullableOracleRepeatableTaskAllOfContract struct {
	value *OracleRepeatableTaskAllOfContract
	isSet bool
}

func (v NullableOracleRepeatableTaskAllOfContract) Get() *OracleRepeatableTaskAllOfContract {
	return v.value
}

func (v *NullableOracleRepeatableTaskAllOfContract) Set(val *OracleRepeatableTaskAllOfContract) {
	v.value = val
	v.isSet = true
}

func (v NullableOracleRepeatableTaskAllOfContract) IsSet() bool {
	return v.isSet
}

func (v *NullableOracleRepeatableTaskAllOfContract) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableOracleRepeatableTaskAllOfContract(val *OracleRepeatableTaskAllOfContract) *NullableOracleRepeatableTaskAllOfContract {
	return &NullableOracleRepeatableTaskAllOfContract{value: val, isSet: true}
}

func (v NullableOracleRepeatableTaskAllOfContract) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableOracleRepeatableTaskAllOfContract) UnmarshalJSON(src []byte) error {
	v.isSet = true
