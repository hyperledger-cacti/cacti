...
// checks if the GatewayIdentity type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GatewayIdentity{}

// GatewayIdentity The identity of the gateway.
...
func (o GatewayIdentity) MarshalJSON() ([]byte, error) {
...
func (o GatewayIdentity) ToMap() (map[string]interface{}, error) {
...
type NullableGatewayIdentity struct {
	value *GatewayIdentity
	isSet bool
}

func (v NullableGatewayIdentity) Get() *GatewayIdentity {
	return v.value
}

func (v *NullableGatewayIdentity) Set(val *GatewayIdentity) {
	v.value = val
	v.isSet = true
}

func (v NullableGatewayIdentity) IsSet() bool {
	return v.isSet
}

func (v *NullableGatewayIdentity) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGatewayIdentity(val *GatewayIdentity) *NullableGatewayIdentity {
	return &NullableGatewayIdentity{value: val, isSet: true}
}

func (v NullableGatewayIdentity) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGatewayIdentity) UnmarshalJSON(src []byte) error {
	v.isSet = true
