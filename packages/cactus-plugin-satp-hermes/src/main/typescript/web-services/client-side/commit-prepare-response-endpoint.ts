  ...
  implements IWebServiceEndpoint
{
  ...
  public get className(): string {
    return CommitPreparationResponseEndpointV1.CLASS_NAME;
  }

  constructor(
    public readonly options: ICommitPreparationResponseEndpointOptions,
  ) {
  ...
  public async handleRequest(req: Request, res: Response): Promise<void> {
    ...
    try {
      await this.options.gateway.onCommitPrepareResponseReceived(req.body);
