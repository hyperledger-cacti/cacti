...
import { isFabricSigningCredentialType } from "./validateFabricConfig";
...
function isConfigJSON(obj: unknown): obj is ConfigJSON {
  const objRecord = obj as Record<string, unknown>;
  return (
    typeof obj === "object" &&
    obj !== null &&
...
export function isFabricOptionsJSON(obj: unknown): obj is FabricOptionsJSON {
  ...
  return (
    ...
    (!("signCallback" in obj) ||
      isSignPayloadCallback(objRecord.signCallback)) &&
