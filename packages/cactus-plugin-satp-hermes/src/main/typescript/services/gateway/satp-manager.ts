...
import {
  ISATPPersistenceConfig,
  SATPPersistence,
} from "../../satp-persistence";
...
export class SATPManager {
  ...
  private readonly dbLogger: SATPPersistence;
  ...
  constructor(public readonly options: ISATPManagerOptions) {
    ...
    const satpLoggerConfig: ISATPPersistenceConfig = {
    ...
    this.dbLogger = new SATPPersistence(satpLoggerConfig);
