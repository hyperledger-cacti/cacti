...
export class MonitorService {
  ...
  public async init(): Promise<void> {
    ...
    if (!this.sdk) {
      ...
      this.createMetric("gateways", "number of gateways");
      this.createMetric("created_sessions", "total number of sessions created");
      this.createMetric("total_value_sent", "total value sent");
      this.createMetric("total_value_received", "total value received");
      this.createMetric(
        "initiated_transfers",
        "total number of initiated transfers",
      );
      this.createMetric(
      ...
      this.createMetric("gas_used", "total gas used");
      this.createLog(
        "info",
