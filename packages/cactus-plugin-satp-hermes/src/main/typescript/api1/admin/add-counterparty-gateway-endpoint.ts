...
import { AddCounterpartyRequest } from "../../public-api";

export class AddCounterpartyGatewayEndpointV1 implements IWebServiceEndpoint {
  public static readonly CLASS_NAME = "AddCounterpartyGatewayEnpointV1";

  private readonly log: Logger;

  public get className(): string {
    return AddCounterpartyGatewayEndpointV1.CLASS_NAME;
  }
