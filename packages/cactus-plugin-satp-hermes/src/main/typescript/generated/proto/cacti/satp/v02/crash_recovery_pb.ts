 ...
 */
export class RollbackState extends Message<RollbackState> {
  /**
   * @generated from field: string session_id = 1;
   */
  sessionId = "";
  ...
  constructor(data?: PartialMessage<RollbackState>) {
    super();
    proto3.util.initPartial(data, this);
  }

  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "cacti.satp.v02.crash.RollbackState";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "session_id", kind: "scalar", T: 9 /* ScalarType.STRING */ },
    { no: 2, name: "current_stage", kind: "scalar", T: 9 /* ScalarType.STRING */ },
    { no: 3, name: "steps_remaining", kind: "scalar", T: 5 /* ScalarType.INT32 */ },
    { no: 4, name: "rollback_log_entries", kind: "message", T: RollbackLogEntry, repeated: true },
    { no: 5, name: "estimated_time_to_completion", kind: "scalar", T: 9 /* ScalarType.STRING */ },
    { no: 6, name: "status", kind: "scalar", T: 9 /* ScalarType.STRING */ },
    { no: 7, name: "details", kind: "scalar", T: 9 /* ScalarType.STRING */ },
  ]);

  static fromBinary(bytes: Uint8Array, options?: Partial<BinaryReadOptions>): RollbackState {
    return new RollbackState().fromBinary(bytes, options);
  }

  static fromJson(jsonValue: JsonValue, options?: Partial<JsonReadOptions>): RollbackState {
    return new RollbackState().fromJson(jsonValue, options);
  }

  static fromJsonString(jsonString: string, options?: Partial<JsonReadOptions>): RollbackState {
    return new RollbackState().fromJsonString(jsonString, options);
  }

  static equals(a: RollbackState | PlainMessage<RollbackState> | undefined, b: RollbackState | PlainMessage<RollbackState> | undefined): boolean {
    return proto3.util.equals(RollbackState, a, b);
  }
}
