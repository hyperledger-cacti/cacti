 ...
 */
export function instanceOfMultiTokenAsset(
  asset: Asset,
): asset is MultiTokenAsset {
  return (
    instanceOfFungibleAsset(asset) &&
    (asset as FungibleAsset).uniqueDescriptor != null
  );
}
 ...
 */
export function instanceOfNonFungibleAsset(
  asset: Asset,
): asset is NonFungibleAsset {
