  ...
  outputs = { self, nixpkgs, flake-utils, rust-overlay }:
    flake-utils.lib.eachDefaultSystem (system:
      let
        ...
        # Rust version for Solidity/Foundry compilation
        rustVersion = "stable";
      ...
      in
      {
        devShells.default = pkgs.mkShell {
          buildInputs = with pkgs; [
            ...
            nodejs             # v22.x
            corepack           # For yarn support
            yarn

            # Go toolchain
            goToolchain

            # Rust toolchain for Solidity/smart contract compilation
