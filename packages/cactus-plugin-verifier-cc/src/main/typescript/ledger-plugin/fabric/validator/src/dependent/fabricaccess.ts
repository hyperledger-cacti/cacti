...
export async function getSubmitter(cli: any): Promise<unknown> {
  ...
  return cli.getUserContext(submitter.name, true).then((user: any) => {
    return new Promise((resolve, reject) => {
      ...
      const cop = new copService(caUrl, tlsOptions as any, caName, cryptoSuite);
      return cop
        .enroll({
...
export async function getClientAndChannel(): Promise<unknown> {
