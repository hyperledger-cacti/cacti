 ...
 *         3.78e14
 */
export function convNum(value: any, defaultValue: any): number {
  let retValue = 0;
  let defValue = 0;
...
export function convertBlockNumber(value: number): string {
...
export function deccodeCbor(encoded: unknown): Array<any> {
