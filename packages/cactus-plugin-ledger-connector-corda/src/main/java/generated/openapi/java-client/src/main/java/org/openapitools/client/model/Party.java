...
public class Party {
  ...
  public static final String SERIALIZED_NAME_OWNING_KEY = "owningKey";
  ...
  public Party name(CordaX500Name name) {
  ...
  **/
  ...
  public void setName(CordaX500Name name) {
    this.name = name;
  }


  public Party owningKey(PublicKey owningKey) {
  ...
  **/
  ...
  public void setOwningKey(PublicKey owningKey) {
    this.owningKey = owningKey;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.name, party.name) &&
        Objects.equals(this.owningKey, party.owningKey);
  }
  ...
  static {
    ...
    openapiFields.add("owningKey");

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>();
    openapiRequiredFields.add("name");
    openapiRequiredFields.add("owningKey");
  }
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      ...
      CordaX500Name.validateJsonObject(jsonObj.getAsJsonObject("name"));
      // validate the required field `owningKey`
      PublicKey.validateJsonObject(jsonObj.getAsJsonObject("owningKey"));
  }
