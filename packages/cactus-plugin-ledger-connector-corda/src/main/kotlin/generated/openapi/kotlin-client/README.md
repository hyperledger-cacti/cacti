...
*DefaultApi* | [**getFlowV1**](docs/DefaultApi.md#getflowv1) | **GET** /api/v1/plugins/@hyperledger/cactus-plugin-ledger-connector-corda/getFlowCid | This method gets the current status of the specified flow instance.
...
*DefaultApi* | [**listFlowV1**](docs/DefaultApi.md#listflowv1) | **GET** /api/v1/plugins/@hyperledger/cactus-plugin-ledger-connector-corda/listFlows | This method returns an array containing the statuses of all flows running for a specified holding identity. An empty array is returned if there are no flows running.
...
*DefaultApi* | [**startFlowV1**](docs/DefaultApi.md#startflowv1) | **POST** /api/v1/plugins/@hyperledger/cactus-plugin-ledger-connector-corda/startFlow | This method starts a new instance for the specified flow for the specified holding identity.
