...
// checks if the GetFlowCidV1Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetFlowCidV1Response{}

// GetFlowCidV1Response struct for GetFlowCidV1Response
type GetFlowCidV1Response struct {
...
// NewGetFlowCidV1Response instantiates a new GetFlowCidV1Response object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewGetFlowCidV1Response(flowStatus string, holdingIDShortHash string, timestamp time.Time) *GetFlowCidV1Response {
	this := GetFlowCidV1Response{}
...
// NewGetFlowCidV1ResponseWithDefaults instantiates a new GetFlowCidV1Response object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewGetFlowCidV1ResponseWithDefaults() *GetFlowCidV1Response {
	this := GetFlowCidV1Response{}
	return &this
}
...
func (o *GetFlowCidV1Response) GetClientRequestId() string {
...
func (o *GetFlowCidV1Response) GetClientRequestIdOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *GetFlowCidV1Response) HasClientRequestId() bool {
...
func (o *GetFlowCidV1Response) SetClientRequestId(v string) {
	o.ClientRequestId.Set(&v)
}
// SetClientRequestIdNil sets the value for ClientRequestId to be an explicit nil
func (o *GetFlowCidV1Response) SetClientRequestIdNil() {
...
func (o *GetFlowCidV1Response) UnsetClientRequestId() {
	o.ClientRequestId.Unset()
}

// GetFlowError returns the FlowError field value if set, zero value otherwise.
func (o *GetFlowCidV1Response) GetFlowError() FlowV1Error {
...
// and a boolean to check if the value has been set.
func (o *GetFlowCidV1Response) GetFlowErrorOk() (*FlowV1Error, bool) {
	if o == nil || IsNil(o.FlowError) {
		return nil, false
	}
...
func (o *GetFlowCidV1Response) HasFlowError() bool {
	if o != nil && !IsNil(o.FlowError) {
		return true
	}
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *GetFlowCidV1Response) GetFlowIdOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *GetFlowCidV1Response) HasFlowId() bool {
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *GetFlowCidV1Response) GetFlowResultOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *GetFlowCidV1Response) HasFlowResult() bool {
...
// and a boolean to check if the value has been set.
func (o *GetFlowCidV1Response) GetFlowStatusOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *GetFlowCidV1Response) SetFlowStatus(v string) {
	o.FlowStatus = v
}

// GetHoldingIDShortHash returns the HoldingIDShortHash field value
func (o *GetFlowCidV1Response) GetHoldingIDShortHash() string {
	if o == nil {
		var ret string
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *GetFlowCidV1Response) GetHoldingIDShortHashOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *GetFlowCidV1Response) SetHoldingIDShortHash(v string) {
	o.HoldingIDShortHash = v
}

// GetTimestamp returns the Timestamp field value
func (o *GetFlowCidV1Response) GetTimestamp() time.Time {
	if o == nil {
		var ret time.Time
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *GetFlowCidV1Response) GetTimestampOk() (*time.Time, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *GetFlowCidV1Response) SetTimestamp(v time.Time) {
	o.Timestamp = v
}

func (o GetFlowCidV1Response) MarshalJSON() ([]byte, error) {
...
func (o GetFlowCidV1Response) ToMap() (map[string]interface{}, error) {
...
type NullableGetFlowCidV1Response struct {
	value *GetFlowCidV1Response
	isSet bool
}

func (v NullableGetFlowCidV1Response) Get() *GetFlowCidV1Response {
	return v.value
}

func (v *NullableGetFlowCidV1Response) Set(val *GetFlowCidV1Response) {
	v.value = val
	v.isSet = true
}

func (v NullableGetFlowCidV1Response) IsSet() bool {
	return v.isSet
}

func (v *NullableGetFlowCidV1Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetFlowCidV1Response(val *GetFlowCidV1Response) *NullableGetFlowCidV1Response {
	return &NullableGetFlowCidV1Response{value: val, isSet: true}
}

func (v NullableGetFlowCidV1Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetFlowCidV1Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
