...
export class ConfigUtil {
    ...
    static getConfig(): object {
        const configCommon: any = yaml.safeLoad(fs.readFileSync("/etc/cactus/default.yaml", 'utf8'));
        const configAppli: any = yaml.safeLoad(fs.readFileSync("/etc/cactus/usersetting.yaml", 'utf8'));
