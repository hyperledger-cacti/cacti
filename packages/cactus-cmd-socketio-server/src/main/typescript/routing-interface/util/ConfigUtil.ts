...
export class ConfigUtil {
    ...
    static getConfig(): object {
        const configCommon: any = JSON.parse(fs.readFileSync("/etc/cactus/default.json", 'utf8'));
        const configAppli: any = JSON.parse(fs.readFileSync("/etc/cactus/usersetting.json", 'utf8'));
