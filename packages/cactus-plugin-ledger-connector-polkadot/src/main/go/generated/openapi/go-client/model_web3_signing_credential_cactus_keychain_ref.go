...
func NewWeb3SigningCredentialCactusKeychainRef(type_ Web3SigningCredentialType, keychainEntryKey string, keychainId string) *Web3SigningCredentialCactusKeychainRef {
