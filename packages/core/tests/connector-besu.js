...
describe(`ConnectorBesu Constructor`, function() {
...
describe(`ConnectorBesu getAccessToken`, function() {
  const options = config.blockchains.besu;
  const connector1 = new Connector.BESU(options);
...
describe(`ConnectorBesu addForeignValidator`, function() {
  const options = config.blockchains.besu;
  const connector2 = new Connector.BESU(options);
...
describe(`ConnectorBesu verifySignature`, function() {
  const options = config.blockchains.besu;
  const connector3 = new Connector.BESU(options);
...
describe(`ConnectorBesu verifyMultisig`, function() {
  const options = config.blockchains.besu;
  const connector4 = new Connector.BESU(options);
