...
import (
	...
	"testing"
	openapiclient "github.com/hyperledger/cactus-plugin-keychain-google-sm/src/main/go/generated/openapi/go-client"
)

func Test_cactus-plugin-keychain-google-sm_DefaultApiService(t *testing.T) {
