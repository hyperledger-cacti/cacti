...
import (
	...
	"testing"
	openapiclient "github.com/hyperledger/cactus-plugin-keychain-aws-sm/src/main/go/generated/openapi/go-client"
)

func Test_cactus-plugin-keychain-aws-sm_DefaultApiService(t *testing.T) {
