...
export interface ProcessViewEndpointOptions {
  logLevel?: LogLevelDesc;
  bungee: PluginBungeeHermes;
}

export class ProcessViewEndpointV1 implements IWebServiceEndpoint {
  public static readonly CLASS_NAME = "ClientEndpointV1";

  private readonly log: Logger;

  public get className(): string {
    return ProcessViewEndpointV1.CLASS_NAME;
  }

  constructor(public readonly options: ProcessViewEndpointOptions) {
  ...
  public getPath(): string {
    const apiPath =
      OAS.paths[
        "/api/v1/plugins/@hyperledger-cacti/cactus-plugin-bungee-hermes/process-view"
      ];
  ...
  public async handleRequest(req: Request, res: Response): Promise<void> {
    ...
    try {
      const view = this.options.bungee.onProcessView(req.body);
