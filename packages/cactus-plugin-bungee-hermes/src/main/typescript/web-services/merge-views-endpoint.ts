...
export interface MergeViewsEndpointOptions {
  logLevel?: LogLevelDesc;
  bungee: PluginBungeeHermes;
}

export class MergeViewsEndpointV1 implements IWebServiceEndpoint {
  public static readonly CLASS_NAME = "ClientEndpointV1";

  private readonly log: Logger;

  public get className(): string {
    return MergeViewsEndpointV1.CLASS_NAME;
  }

  constructor(public readonly options: MergeViewsEndpointOptions) {
  ...
  public getPath(): string {
    const apiPath =
      OAS.paths[
        "/api/v1/plugins/@hyperledger-cacti/cactus-plugin-bungee-hermes/merge-views"
      ];
  ...
  public async handleRequest(req: Request, res: Response): Promise<void> {
    ...
    try {
      const view = this.options.bungee.onMergeViews(req.body);
