  ...
  describe("DAML SIMPLE IOU TRANSACTION", () => {
    it("DAML SIMPLE IOU TRANSACTION", async () => {
      ...
      const getTokenForAlice: string =
        damlTestLedger.getIdentifierByDisplayName(parsePartyInvolved, "Alice");
    ...
    ===================*/
      ...
      // console.log("STEP 2. Transfer IOU to BOB result:")
      // console.log(exerciseIou)
      ...
      // console.log("STEP 3. Accept Transfer of IOU as BOB result:")
      ...
      // console.log("STEP 4. For final check, query as BOB to check if IOU has been transferred succesfully")
      // console.log(responseForIOUResult)
