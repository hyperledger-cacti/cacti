...
export interface ISATPGatewayRunnerConstructorOptions {
  ...
  errorLogFile?: string;
  knexDir?: string;
  enableDefaultMigration?: boolean;
...
export const SATP_GATEWAY_RUNNER_OPTIONS_JOI_SCHEMA: Joi.Schema =
  Joi.object().keys({
    ...
    enableDefaultMigration: Joi.boolean().optional(),
...
export class SATPGatewayRunner implements ITestLedger {
  ...
  public readonly enableDefaultMigration: boolean;
  ...
  constructor(
    ...
    this.enableDefaultMigration =
      options.enableDefaultMigration ??
      SATP_GATEWAY_RUNNER_DEFAULT_OPTIONS.enableDefaultMigration;
  ...
  private validateConstructorOptions(): void {
    const validationResult = SATP_GATEWAY_RUNNER_OPTIONS_JOI_SCHEMA.validate({
      ...
      enableDefaultMigration: this.enableDefaultMigration,
