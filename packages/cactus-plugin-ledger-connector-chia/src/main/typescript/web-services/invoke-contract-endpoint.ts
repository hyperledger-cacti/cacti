...
export class InvokeContractEndpoint implements IWebServiceEndpoint {
  ...
  public get oasPath(): typeof OAS.paths["/api/v1/plugins/@hyperledger/cactus-plugin-ledger-connector-chia/invoke-contract"] {
    return OAS.paths[
      "/api/v1/plugins/@hyperledger/cactus-plugin-ledger-connector-chia/invoke-contract"
    ];
  }
