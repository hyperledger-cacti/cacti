...
export class GetBalanceEndpoint implements IWebServiceEndpoint {
  ...
  public get oasPath(): typeof OAS.paths["/api/v1/plugins/@hyperledger/cactus-plugin-ledger-connector-chia/get-balance"] {
    return OAS.paths[
      "/api/v1/plugins/@hyperledger/cactus-plugin-ledger-connector-chia/get-balance"
    ];
  }
