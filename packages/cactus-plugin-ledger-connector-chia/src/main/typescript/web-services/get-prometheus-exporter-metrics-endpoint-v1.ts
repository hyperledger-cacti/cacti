...
export class GetPrometheusExporterMetricsEndpointV1
  ...
  public get oasPath(): typeof OAS.paths["/api/v1/plugins/@hyperledger/cactus-plugin-ledger-connector-chia/get-prometheus-exporter-metrics"] {
    return OAS.paths[
      "/api/v1/plugins/@hyperledger/cactus-plugin-ledger-connector-chia/get-prometheus-exporter-metrics"
    ];
  }
