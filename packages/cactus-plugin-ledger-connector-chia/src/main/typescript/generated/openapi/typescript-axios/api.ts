...
/* eslint-disable */
/**
 * Hyperledger Cactus Plugin - Connector Chia
 * Can perform basic tasks on a Chia ledger
 *
 ...
 * 
 * @export
 * @interface ChiaPrivateTransactionConfig
 */
export interface ChiaPrivateTransactionConfig {
    /**
     * 
     * @type {string}
     * @memberof ChiaPrivateTransactionConfig
     */
    privateFrom: string;
    /**
     * 
 ...
 * 
 * @export
 * @interface ChiaTransactionConfig
 */
export interface ChiaTransactionConfig {
    [key: string]: object | any;

    /**
     * 
     * @type {string}
     * @memberof ChiaTransactionConfig
     */
...
export interface DeployContractSolidityBytecodeV1Request {
    ...
    /**
     * 
     * @type {ChiaPrivateTransactionConfig}
     * @memberof DeployContractSolidityBytecodeV1Request
     */
    privateTransactionConfig?: ChiaPrivateTransactionConfig;
}
/**
 * 
 * @export
 ...
 * 
 * @export
 * @interface GetChiaRecordV1Request
 */
export interface GetChiaRecordV1Request {
    /**
     * 
     * @type {InvokeContractV1Request}
     * @memberof GetChiaRecordV1Request
     */
 ...
 * 
 * @export
 * @interface GetChiaRecordV1Response
 */
export interface GetChiaRecordV1Response {
    /**
     * 
     * @type {string}
     * @memberof GetChiaRecordV1Response
     */
    ledgerId?: string;
    /**
     * 
...
export interface RunTransactionRequest {
    ...
    /**
     * 
     * @type {ChiaTransactionConfig}
     * @memberof RunTransactionRequest
     */
    transactionConfig: ChiaTransactionConfig;
    /**
     * 
...
export enum WatchBlocksV1 {
    Subscribe = 'org.hyperledger.cactus.api.async.chia.WatchBlocksV1.Subscribe',
    Next = 'org.hyperledger.cactus.api.async.chia.WatchBlocksV1.Next',
    Unsubscribe = 'org.hyperledger.cactus.api.async.chia.WatchBlocksV1.Unsubscribe',
    Error = 'org.hyperledger.cactus.api.async.chia.WatchBlocksV1.Error',
    Complete = 'org.hyperledger.cactus.api.async.chia.WatchBlocksV1.Complete'
}
...
export const DefaultApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
        ...
        deployContractSolBytecodeV1: async (deployContractSolidityBytecodeV1Request?: DeployContractSolidityBytecodeV1Request, options: any = {}): Promise<RequestArgs> => {
            const localVarPath = `/api/v1/plugins/@hyperledger/cactus-plugin-ledger-connector-chia/deploy-contract-solidity-bytecode`;
        ...
        getBalanceV1: async (getBalanceV1Request?: GetBalanceV1Request, options: any = {}): Promise<RequestArgs> => {
            const localVarPath = `/api/v1/plugins/@hyperledger/cactus-plugin-ledger-connector-chia/get-balance`;
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
            let baseOptions;
            if (configuration) {
        ...
        getBlockV1: async (getBlockV1Request?: GetBlockV1Request, options: any = {}): Promise<RequestArgs> => {
            const localVarPath = `/api/v1/plugins/@hyperledger/cactus-plugin-ledger-connector-chia/get-block`;
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
            let baseOptions;
            if (configuration) {
         ...
         * @param {GetChiaRecordV1Request} [getChiaRecordV1Request] 
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        getChiaRecordV1: async (getChiaRecordV1Request?: GetChiaRecordV1Request, options: any = {}): Promise<RequestArgs> => {
            const localVarPath = `/api/v1/plugins/@hyperledger/cactus-plugin-ledger-connector-chia/get-chia-record`;
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
            let baseOptions;
            if (configuration) {
            ...
            let headersFromBaseOptions = baseOptions && baseOptions.headers ? baseOptions.headers : {};
            localVarRequestOptions.headers = {...localVarHeaderParameter, ...headersFromBaseOptions, ...options.headers};
            localVarRequestOptions.data = serializeDataIfNeeded(getChiaRecordV1Request, localVarRequestOptions, configuration)
        ...
        getPastLogsV1: async (getPastLogsV1Request?: GetPastLogsV1Request, options: any = {}): Promise<RequestArgs> => {
            const localVarPath = `/api/v1/plugins/@hyperledger/cactus-plugin-ledger-connector-chia/get-past-logs`;
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
            let baseOptions;
            if (configuration) {
        ...
        getPrometheusMetricsV1: async (options: any = {}): Promise<RequestArgs> => {
            const localVarPath = `/api/v1/plugins/@hyperledger/cactus-plugin-ledger-connector-chia/get-prometheus-exporter-metrics`;
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
            let baseOptions;
            if (configuration) {
        ...
        /**
         * 
         * @summary Executes a transaction on a chia ledger
        ...
        getTransactionV1: async (getTransactionV1Request?: GetTransactionV1Request, options: any = {}): Promise<RequestArgs> => {
            const localVarPath = `/api/v1/plugins/@hyperledger/cactus-plugin-ledger-connector-chia/get-transaction`;
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
            let baseOptions;
            if (configuration) {
        ...
        /**
         * 
         * @summary Invokes a contract on a chia ledger
        ...
        invokeContractV1: async (invokeContractV1Request?: InvokeContractV1Request, options: any = {}): Promise<RequestArgs> => {
            const localVarPath = `/api/v1/plugins/@hyperledger/cactus-plugin-ledger-connector-chia/invoke-contract`;
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
            let baseOptions;
            if (configuration) {
        ...
        runTransactionV1: async (runTransactionRequest?: RunTransactionRequest, options: any = {}): Promise<RequestArgs> => {
            const localVarPath = `/api/v1/plugins/@hyperledger/cactus-plugin-ledger-connector-chia/run-transaction`;
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
            let baseOptions;
            if (configuration) {
        ...
        signTransactionV1: async (signTransactionRequest: SignTransactionRequest, options: any = {}): Promise<RequestArgs> => {
            ...
            const localVarPath = `/api/v1/plugins/@hyperledger/cactus-plugin-ledger-connector-chia/sign-transaction`;
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
            let baseOptions;
            if (configuration) {
...
export const DefaultApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async getChiaRecordV1(getChiaRecordV1Request?: GetChiaRecordV1Request, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<GetChiaRecordV1Response>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.getChiaRecordV1(getChiaRecordV1Request, options);
            return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
        },
        /**
         * 
...
export const DefaultApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        getChiaRecordV1(getChiaRecordV1Request?: GetChiaRecordV1Request, options?: any): AxiosPromise<GetChiaRecordV1Response> {
            return localVarFp.getChiaRecordV1(getChiaRecordV1Request, options).then((request) => request(axios, basePath));
        },
        /**
         * 
         * @summary Gets past logs, matching the given options.
...
export class DefaultApi extends BaseAPI {
     ...
     * @memberof DefaultApi
     */
    public getChiaRecordV1(getChiaRecordV1Request?: GetChiaRecordV1Request, options?: any) {
        return DefaultApiFp(this.configuration).getChiaRecordV1(getChiaRecordV1Request, options).then((request) => request(this.axios, this.basePath));
    }
