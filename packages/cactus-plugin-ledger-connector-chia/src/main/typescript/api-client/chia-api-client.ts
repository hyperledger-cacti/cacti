...
export class ChiaApiClientOptions extends Configuration {
  readonly logLevel?: LogLevelDesc;
  readonly wsApiHost?: string;
  readonly wsApiPath?: string;
}

export class ChiaApiClient
  extends DefaultApi
  implements ISocketApiClient<WatchBlocksV1Progress> {
  public static readonly CLASS_NAME = "ChiaApiClient";
  ...
  public get className(): string {
    return ChiaApiClient.CLASS_NAME;
  }

  constructor(public readonly options: ChiaApiClientOptions) {
    super(options);
