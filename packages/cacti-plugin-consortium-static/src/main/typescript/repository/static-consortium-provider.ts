...
export interface IStaticConsortiumProviderOptions {
  logLevel?: LogLevelDesc;
  apiClient: ConsortiumStaticApi;
}

export class StaticConsortiumProvider
  implements IAsyncProvider<ConsortiumDatabase>
{
  public static readonly CLASS_NAME = "StaticConsortiumProvider";

  private readonly log: Logger;

  public get className(): string {
    return StaticConsortiumProvider.CLASS_NAME;
  }

  constructor(public readonly options: IStaticConsortiumProviderOptions) {
  ...
  parseConsortiumJws(response: GetConsortiumJwsResponse): ConsortiumDatabase {
    const fnTag = `StaticConsortiumProvider#parseConsortiumJws()`;
