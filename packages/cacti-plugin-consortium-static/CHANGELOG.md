...
**Note:** Version bump only for package @hyperledger-cacti/cacti-plugin-consortium-static
...
**Note:** Version bump only for package @hyperledger/cacti-plugin-consortium-static
