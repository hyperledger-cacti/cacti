...
func (a *DefaultApiService) GetSingleStatusV1Execute(r ApiGetSingleStatusV1Request) (int32, *http.Response, error) {
	...
	localVarPath := localBasePath + "/api/v1/plugins/@hyperledger-cacti/cactus-plugin-htlc-eth-besu/get-single-status"
...
func (a *DefaultApiService) GetStatusV1Execute(r ApiGetStatusV1Request) ([]int32, *http.Response, error) {
	...
	localVarPath := localBasePath + "/api/v1/plugins/@hyperledger-cacti/cactus-plugin-htlc-eth-besu/get-status"
...
/*
InitializeV1 Method for InitializeV1
...
func (a *DefaultApiService) InitializeV1Execute(r ApiInitializeV1Request) (*RunTransactionResponse, *http.Response, error) {
	...
	localVarPath := localBasePath + "/api/v1/plugins/@hyperledger-cacti/cactus-plugin-htlc-eth-besu/initialize"
...
func (r ApiNewContractV1Request) NewContractObj(newContractObj NewContractObj) ApiNewContractV1Request {
	r.newContractObj = &newContractObj
	return r
}
...
/*
NewContractV1 Method for NewContractV1
...
func (a *DefaultApiService) NewContractV1Execute(r ApiNewContractV1Request) (*InvokeContractV1Response, *http.Response, error) {
	...
	localVarPath := localBasePath + "/api/v1/plugins/@hyperledger-cacti/cactus-plugin-htlc-eth-besu/new-contract"
	...
	// body params
	localVarPostBody = r.newContractObj
	req, err := a.client.prepareRequest(r.ctx, localVarPath, localVarHTTPMethod, localVarPostBody, localVarHeaderParams, localVarQueryParams, localVarFormParams, formFiles)
	if err != nil {
		return localVarReturnValue, nil, err
	}
...
func (r ApiRefundV1Request) RefundReq(refundReq RefundReq) ApiRefundV1Request {
...
func (a *DefaultApiService) RefundV1Execute(r ApiRefundV1Request) (*InvokeContractV1Response, *http.Response, error) {
	...
	localVarPath := localBasePath + "/api/v1/plugins/@hyperledger-cacti/cactus-plugin-htlc-eth-besu/refund"
...
func (r ApiWithdrawV1Request) WithdrawReq(withdrawReq WithdrawReq) ApiWithdrawV1Request {
	r.withdrawReq = &withdrawReq
	return r
}
...
/*
WithdrawV1 Method for WithdrawV1
...
func (a *DefaultApiService) WithdrawV1Execute(r ApiWithdrawV1Request) (*InvokeContractV1Response, *http.Response, error) {
	...
	localVarPath := localBasePath + "/api/v1/plugins/@hyperledger-cacti/cactus-plugin-htlc-eth-besu/withdraw"
	...
	// body params
	localVarPostBody = r.withdrawReq
	req, err := a.client.prepareRequest(r.ctx, localVarPath, localVarHTTPMethod, localVarPostBody, localVarHeaderParams, localVarQueryParams, localVarFormParams, formFiles)
	if err != nil {
		return localVarReturnValue, nil, err
	}
