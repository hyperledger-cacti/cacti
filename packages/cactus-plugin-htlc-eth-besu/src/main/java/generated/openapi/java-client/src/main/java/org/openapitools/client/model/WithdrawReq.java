...
public class WithdrawReq {
  ...
  public WithdrawReq id(String id) {
  ...
  **/
  ...
  public WithdrawReq secret(String secret) {
  ...
  **/
  ...
  public WithdrawReq web3SigningCredential(Web3SigningCredential web3SigningCredential) {
  ...
  **/
  ...
  public WithdrawReq connectorId(String connectorId) {
  ...
  **/
  ...
  public WithdrawReq keychainId(String keychainId) {
  ...
  **/
  ...
  public WithdrawReq gas(NewContractObjGas gas) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, withdrawReq.id) &&
        Objects.equals(this.secret, withdrawReq.secret) &&
        Objects.equals(this.web3SigningCredential, withdrawReq.web3SigningCredential) &&
        Objects.equals(this.connectorId, withdrawReq.connectorId) &&
        Objects.equals(this.keychainId, withdrawReq.keychainId) &&
        Objects.equals(this.gas, withdrawReq.gas);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to WithdrawReq
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!WithdrawReq.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in WithdrawReq is not found in the empty JSON string", WithdrawReq.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!WithdrawReq.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `WithdrawReq` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : WithdrawReq.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!WithdrawReq.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'WithdrawReq' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<WithdrawReq> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(WithdrawReq.class));

       return (TypeAdapter<T>) new TypeAdapter<WithdrawReq>() {
           @Override
           public void write(JsonWriter out, WithdrawReq value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public WithdrawReq read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of WithdrawReq given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of WithdrawReq
  * @throws IOException if the JSON string is invalid with respect to WithdrawReq
  */
  public static WithdrawReq fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, WithdrawReq.class);
  }

 /**
  * Convert an instance of WithdrawReq to an JSON string
  *
  * @return JSON string
  */
