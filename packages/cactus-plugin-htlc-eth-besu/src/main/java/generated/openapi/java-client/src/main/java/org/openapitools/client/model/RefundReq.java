...
public class RefundReq {
  ...
  **/
  ...
  public RefundReq web3SigningCredential(Web3SigningCredential web3SigningCredential) {
  ...
  **/
  ...
  public RefundReq connectorId(String connectorId) {
  ...
  **/
  ...
  public RefundReq keychainId(String keychainId) {
  ...
  **/
  ...
  public RefundReq gas(NewContractObjGas gas) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, refundReq.id) &&
        Objects.equals(this.web3SigningCredential, refundReq.web3SigningCredential) &&
        Objects.equals(this.connectorId, refundReq.connectorId) &&
        Objects.equals(this.keychainId, refundReq.keychainId) &&
        Objects.equals(this.gas, refundReq.gas);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to RefundReq
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!RefundReq.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in RefundReq is not found in the empty JSON string", RefundReq.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!RefundReq.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `RefundReq` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : RefundReq.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!RefundReq.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'RefundReq' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<RefundReq> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(RefundReq.class));

       return (TypeAdapter<T>) new TypeAdapter<RefundReq>() {
           @Override
           public void write(JsonWriter out, RefundReq value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public RefundReq read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of RefundReq given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of RefundReq
  * @throws IOException if the JSON string is invalid with respect to RefundReq
  */
  public static RefundReq fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, RefundReq.class);
  }

 /**
  * Convert an instance of RefundReq to an JSON string
  *
  * @return JSON string
  */
