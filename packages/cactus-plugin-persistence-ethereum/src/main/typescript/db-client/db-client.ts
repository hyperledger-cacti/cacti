...
type TokenMetadataERC1155RowType = SchemaTables["token_metadata_erc1155"]["Row"];
type TokenMetadataERC1155InsertType = SchemaTables["token_metadata_erc1155"]["Insert"];
 ...
 */
  public async getTokenMetadataERC1155(): Promise<TokenMetadataERC1155RowType[]> {
    this.assertConnected();
 ...
 */
  public async upsertTokenERC1155(token: TokenERC1155InsertType): Promise<void> {
    this.assertConnected();
