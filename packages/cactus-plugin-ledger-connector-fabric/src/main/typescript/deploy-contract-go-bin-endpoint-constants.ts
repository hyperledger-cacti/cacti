 ...
 */
export class DeployContractGoBinEndpointV1 {
  public static readonly HTTP_PATH: string =
    "/api/v1/plugins/@hyperledger/cactus-plugin-ledger-connectur-fabric/deploy-contract-go-bin";

  public static readonly HTTP_VERB_LOWER_CASE: string = "post";

  public static readonly OPENAPI_OPERATION_ID: string = "deployContractGoBin";
}
