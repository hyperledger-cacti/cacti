...
// GetSkipDecode returns the SkipDecode field value if set, zero value otherwise.
func (o *GetBlockRequestV1) GetSkipDecode() bool {
	if o == nil || IsNil(o.SkipDecode) {
		var ret bool
		return ret
	}
	return *o.SkipDecode
...
// GetSkipDecodeOk returns a tuple with the SkipDecode field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *GetBlockRequestV1) GetSkipDecodeOk() (*bool, bool) {
	if o == nil || IsNil(o.SkipDecode) {
		return nil, false
	}
	return o.SkipDecode, true
}

// HasSkipDecode returns a boolean if a field has been set.
func (o *GetBlockRequestV1) HasSkipDecode() bool {
	if o != nil && !IsNil(o.SkipDecode) {
		return true
	}
...
// SetSkipDecode gets a reference to the given bool and assigns it to the SkipDecode field.
func (o *GetBlockRequestV1) SetSkipDecode(v bool) {
	o.SkipDecode = &v
}
...
func (o GetBlockRequestV1) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.SkipDecode) {
		toSerialize["skipDecode"] = o.SkipDecode
	}
