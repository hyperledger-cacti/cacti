...
import (
	...
	"testing"
	openapiclient "github.com/hyperledger/cactus-plugin-keychain-vault/src/main/go/generated/openapi/go-client"
)

func Test_cactus-plugin-keychain-vault_DefaultApiService(t *testing.T) {
