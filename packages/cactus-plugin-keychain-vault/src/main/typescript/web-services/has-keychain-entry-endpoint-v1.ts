...
import { HasKeychainEntryResponseV1 } from "./../generated/openapi/typescript-axios/index.js";
...
export class HasKeychainEntryEndpointV1 implements IWebServiceEndpoint {
  ...
  public get oasPath(): (typeof OAS.paths)["/api/v1/plugins/@hyperledger/cactus-plugin-keychain-vault/has-keychain-entry"] {
    return OAS.paths[
