...
public class DefaultApi {
    ...
    public okhttp3.Call deleteKeychainEntryV1Call(DeleteKeychainEntryRequestV1 deleteKeychainEntryRequestV1, final ApiCallback _callback) throws ApiException {
        ...
        String localVarPath = "/api/v1/plugins/@hyperledger/cactus-plugin-keychain-vault/delete-keychain-entry";
    ...
    /**
     * Deletes an entry from the keychain stored under the provided key. (asynchronously)
     * 
     * @param deleteKeychainEntryRequestV1  (optional)
    ...
    public okhttp3.Call getKeychainEntryV1Call(GetKeychainEntryRequestV1 getKeychainEntryRequestV1, final ApiCallback _callback) throws ApiException {
        ...
        // create path and map variables
        String localVarPath = "/api/v1/plugins/@hyperledger/cactus-plugin-keychain-vault/get-keychain-entry";
    ...
    public okhttp3.Call getPrometheusMetricsV1Call(final ApiCallback _callback) throws ApiException {
        ...
        // create path and map variables
        String localVarPath = "/api/v1/plugins/@hyperledger/cactus-plugin-keychain-vault/get-prometheus-exporter-metrics";
    ...
    public okhttp3.Call hasKeychainEntryV1Call(HasKeychainEntryRequestV1 hasKeychainEntryRequestV1, final ApiCallback _callback) throws ApiException {
        ...
        // create path and map variables
        String localVarPath = "/api/v1/plugins/@hyperledger/cactus-plugin-keychain-vault/has-keychain-entry";
    ...
    /**
     * Retrieves the information regarding a key being present on the keychain or not. (asynchronously)
     * 
     * @param hasKeychainEntryRequestV1  (optional)
     * @param _callback The callback to be executed when the API call finishes
     * @return The request call
    ...
    public okhttp3.Call setKeychainEntryV1Call(SetKeychainEntryRequestV1 setKeychainEntryRequestV1, final ApiCallback _callback) throws ApiException {
        ...
        // create path and map variables
        String localVarPath = "/api/v1/plugins/@hyperledger/cactus-plugin-keychain-vault/set-keychain-entry";
