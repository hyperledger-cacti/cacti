...
import { DeleteKeychainEntryRequestV1 } from "../generated/openapi/typescript-axios";
...
export class DeleteKeychainEntryEndpoint implements IWebServiceEndpoint {
  ...
  public getOasPath() {
    return OAS.paths[
      "/api/v1/plugins/@hyperledger-cacti/cactus-plugin-keychain-azure-kv/delete-keychain-entry"
    ];
  }
