...
import { ConsortiumRepository } from "@hyperledger-cacti/cactus-core";
import { DefaultApi as ApiConsortium } from "@hyperledger-cacti/cactus-plugin-consortium-manual";
import { DefaultConsortiumProvider } from "./default-consortium-provider";

import { Configuration, BaseAPI } from "@hyperledger-cacti/cactus-core-api";
...
export class ApiClient extends BaseAPI {
   ...
   * `@hyperledger-cacti/cactus-plugin-consortium-manual` which holds the consortium
