...
import { DefaultApi as ApiConsortium } from "@hyperledger-cacti/cacti-plugin-consortium-static";
...
export class ApiClient extends BaseAPI {
   ...
   * `@hyperledger-cacti/cacti-plugin-consortium-static` which holds the consortium
