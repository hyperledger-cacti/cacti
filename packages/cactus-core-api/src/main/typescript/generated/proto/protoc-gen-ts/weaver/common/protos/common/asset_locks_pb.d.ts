...
export class AssetLockHTLC extends jspb.Message { 
    ...
    getTimespec(): AssetLockHTLC.TimeSpec;
    setTimespec(value: AssetLockHTLC.TimeSpec): AssetLockHTLC;
...
export class AssetExchangeAgreement extends jspb.Message { 
    getType(): string;
    setType(value: string): AssetExchangeAgreement;
    getId(): string;
...
export class FungibleAssetExchangeAgreement extends jspb.Message { 
    getType(): string;
    setType(value: string): FungibleAssetExchangeAgreement;
    getNumunits(): number;
