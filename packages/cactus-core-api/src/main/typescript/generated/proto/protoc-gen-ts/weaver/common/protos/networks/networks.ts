...
export namespace networks.networks {
    ...
    export abstract class UnimplementedNetworkService {
        ...
        abstract RequestState(call: grpc_1.ServerUnaryCall<NetworkQuery, dependency_1.common.ack.Ack>, callback: grpc_1.sendUnaryData<dependency_1.common.ack.Ack>): void;
        abstract GetState(call: grpc_1.ServerUnaryCall<GetStateMessage, dependency_2.common.state.RequestState>, callback: grpc_1.sendUnaryData<dependency_2.common.state.RequestState>): void;
        abstract RequestDatabase(call: grpc_1.ServerUnaryCall<DbName, RelayDatabase>, callback: grpc_1.sendUnaryData<RelayDatabase>): void;
    }
    export class NetworkClient extends grpc_1.makeGenericClientConstructor(UnimplementedNetworkService.definition, "Network", {}) {
        ...
        RequestState: GrpcUnaryServiceInterface<NetworkQuery, dependency_1.common.ack.Ack> = (message: NetworkQuery, metadata: grpc_1.Metadata | grpc_1.CallOptions | grpc_1.requestCallback<dependency_1.common.ack.Ack>, options?: grpc_1.CallOptions | grpc_1.requestCallback<dependency_1.common.ack.Ack>, callback?: grpc_1.requestCallback<dependency_1.common.ack.Ack>): grpc_1.ClientUnaryCall => {
            return super.RequestState(message, metadata, options, callback);
        };
        GetState: GrpcUnaryServiceInterface<GetStateMessage, dependency_2.common.state.RequestState> = (message: GetStateMessage, metadata: grpc_1.Metadata | grpc_1.CallOptions | grpc_1.requestCallback<dependency_2.common.state.RequestState>, options?: grpc_1.CallOptions | grpc_1.requestCallback<dependency_2.common.state.RequestState>, callback?: grpc_1.requestCallback<dependency_2.common.state.RequestState>): grpc_1.ClientUnaryCall => {
            return super.GetState(message, metadata, options, callback);
        };
        RequestDatabase: GrpcUnaryServiceInterface<DbName, RelayDatabase> = (message: DbName, metadata: grpc_1.Metadata | grpc_1.CallOptions | grpc_1.requestCallback<RelayDatabase>, options?: grpc_1.CallOptions | grpc_1.requestCallback<RelayDatabase>, callback?: grpc_1.requestCallback<RelayDatabase>): grpc_1.ClientUnaryCall => {
