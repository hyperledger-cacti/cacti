...
export namespace common.asset_locks {
    ...
    export class AssetLock extends pb_1.Message {
        ...
        get lockMechanism() {
            return pb_1.Message.getFieldWithDefault(this, 1, LockMechanism.HTLC) as LockMechanism;
        }
        ...
        serialize(w?: pb_1.BinaryWriter): Uint8Array | void {
            ...
            if (this.lockMechanism != LockMechanism.HTLC)
                writer.writeEnum(1, this.lockMechanism);
            if (this.lockInfo.length)
    ...
    export class AssetLockHTLC extends pb_1.Message {
        ...
        get timeSpec() {
            return pb_1.Message.getFieldWithDefault(this, 3, AssetLockHTLC.TimeSpec.EPOCH) as AssetLockHTLC.TimeSpec;
        }
        ...
        serialize(w?: pb_1.BinaryWriter): Uint8Array | void {
            const writer = w || new pb_1.BinaryWriter();
            if (this.hashBase64.length)
                writer.writeBytes(1, this.hashBase64);
            if (this.expiryTimeSecs != 0)
                writer.writeUint64(2, this.expiryTimeSecs);
            if (this.timeSpec != AssetLockHTLC.TimeSpec.EPOCH)
    ...
    export class AssetClaimHTLC extends pb_1.Message {
        ...
        serialize(w?: pb_1.BinaryWriter): Uint8Array | void {
            const writer = w || new pb_1.BinaryWriter();
            if (this.hashPreimageBase64.length)
