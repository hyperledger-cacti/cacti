...
export namespace relay.datatransfer {
    ...
    export abstract class UnimplementedDataTransferService {
        ...
        abstract RequestState(call: grpc_1.ServerUnaryCall<dependency_3.common.query.Query, dependency_1.common.ack.Ack>, callback: grpc_1.sendUnaryData<dependency_1.common.ack.Ack>): void;
        abstract SendState(call: grpc_1.ServerUnaryCall<dependency_2.common.state.ViewPayload, dependency_1.common.ack.Ack>, callback: grpc_1.sendUnaryData<dependency_1.common.ack.Ack>): void;
        abstract SendDriverState(call: grpc_1.ServerUnaryCall<dependency_2.common.state.ViewPayload, dependency_1.common.ack.Ack>, callback: grpc_1.sendUnaryData<dependency_1.common.ack.Ack>): void;
    }
    export class DataTransferClient extends grpc_1.makeGenericClientConstructor(UnimplementedDataTransferService.definition, "DataTransfer", {}) {
        ...
        RequestState: GrpcUnaryServiceInterface<dependency_3.common.query.Query, dependency_1.common.ack.Ack> = (message: dependency_3.common.query.Query, metadata: grpc_1.Metadata | grpc_1.CallOptions | grpc_1.requestCallback<dependency_1.common.ack.Ack>, options?: grpc_1.CallOptions | grpc_1.requestCallback<dependency_1.common.ack.Ack>, callback?: grpc_1.requestCallback<dependency_1.common.ack.Ack>): grpc_1.ClientUnaryCall => {
            return super.RequestState(message, metadata, options, callback);
        };
        SendState: GrpcUnaryServiceInterface<dependency_2.common.state.ViewPayload, dependency_1.common.ack.Ack> = (message: dependency_2.common.state.ViewPayload, metadata: grpc_1.Metadata | grpc_1.CallOptions | grpc_1.requestCallback<dependency_1.common.ack.Ack>, options?: grpc_1.CallOptions | grpc_1.requestCallback<dependency_1.common.ack.Ack>, callback?: grpc_1.requestCallback<dependency_1.common.ack.Ack>): grpc_1.ClientUnaryCall => {
            return super.SendState(message, metadata, options, callback);
        };
        SendDriverState: GrpcUnaryServiceInterface<dependency_2.common.state.ViewPayload, dependency_1.common.ack.Ack> = (message: dependency_2.common.state.ViewPayload, metadata: grpc_1.Metadata | grpc_1.CallOptions | grpc_1.requestCallback<dependency_1.common.ack.Ack>, options?: grpc_1.CallOptions | grpc_1.requestCallback<dependency_1.common.ack.Ack>, callback?: grpc_1.requestCallback<dependency_1.common.ack.Ack>): grpc_1.ClientUnaryCall => {
