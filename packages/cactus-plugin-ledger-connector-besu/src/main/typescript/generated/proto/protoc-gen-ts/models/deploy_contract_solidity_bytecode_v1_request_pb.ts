...
export namespace org.hyperledger.cacti.plugin.ledger.connector.besu {
    export class DeployContractSolidityBytecodeV1RequestPB extends pb_1.Message {
        #one_of_decls: number[][] = [];
        ...
        static deserialize(bytes: Uint8Array | pb_1.BinaryReader): DeployContractSolidityBytecodeV1RequestPB {
