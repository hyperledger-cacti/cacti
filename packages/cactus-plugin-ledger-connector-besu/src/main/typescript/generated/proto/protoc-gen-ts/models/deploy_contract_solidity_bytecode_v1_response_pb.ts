 ...
 * source: models/deploy_contract_solidity_bytecode_v1_response_pb.proto
...
export namespace org.hyperledger.cacti.plugin.ledger.connector.besu {
    export class DeployContractSolidityBytecodeV1ResponsePB extends pb_1.Message {
        #one_of_decls: number[][] = [];
        ...
        static fromObject(data: {
            ...
            const message = new DeployContractSolidityBytecodeV1ResponsePB({});
        ...
        static deserialize(bytes: Uint8Array | pb_1.BinaryReader): DeployContractSolidityBytecodeV1ResponsePB {
            const reader = bytes instanceof pb_1.BinaryReader ? bytes : new pb_1.BinaryReader(bytes), message = new DeployContractSolidityBytecodeV1ResponsePB();
        ...
        static deserializeBinary(bytes: Uint8Array): DeployContractSolidityBytecodeV1ResponsePB {
            return DeployContractSolidityBytecodeV1ResponsePB.deserialize(bytes);
        }
    }
}
