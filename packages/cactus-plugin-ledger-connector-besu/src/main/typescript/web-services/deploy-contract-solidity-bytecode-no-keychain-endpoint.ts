...
{
  public static readonly CLASS_NAME = "DeployContractSolidityBytecodeNoKeychainEndpoint";
  ...
  constructor(public readonly options: IDeployContractSolidityBytecodeNoKeychainOptions) {
