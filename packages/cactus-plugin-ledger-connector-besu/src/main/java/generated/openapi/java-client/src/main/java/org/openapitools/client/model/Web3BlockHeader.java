...
public class Web3BlockHeader {
  ...
  public static final String SERIALIZED_NAME_TRANSACTION_ROOT = "transactionRoot";
  @SerializedName(SERIALIZED_NAME_TRANSACTION_ROOT)
  ...
  public static final String SERIALIZED_NAME_RECEIPT_ROOT = "receiptRoot";
  ...
  private Web3BlockHeaderTimestamp timestamp;
  ...
  **/
  ...
  public Web3BlockHeader transactionRoot(String transactionRoot) {
  ...
  **/
  ...
  public Web3BlockHeader receiptRoot(String receiptRoot) {
  ...
  **/
  ...
  public Web3BlockHeader timestamp(Web3BlockHeaderTimestamp timestamp) {
  ...
  **/
  @javax.annotation.Nonnull
  public Web3BlockHeaderTimestamp getTimestamp() {
    return timestamp;
  }


  public void setTimestamp(Web3BlockHeaderTimestamp timestamp) {
    this.timestamp = timestamp;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.number, web3BlockHeader.number) &&
        ...
        Objects.equals(this.transactionRoot, web3BlockHeader.transactionRoot) &&
        Objects.equals(this.stateRoot, web3BlockHeader.stateRoot) &&
        Objects.equals(this.receiptRoot, web3BlockHeader.receiptRoot) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(number, hash, parentHash, nonce, sha3Uncles, logsBloom, transactionRoot, stateRoot, receiptRoot, miner, extraData, gasLimit, gasUsed, timestamp);
  }
  ...
  static {
    ...
    openapiFields.add("transactionRoot");
    openapiFields.add("stateRoot");
    openapiFields.add("receiptRoot");
    ...
    openapiRequiredFields.add("transactionRoot");
    openapiRequiredFields.add("stateRoot");
    openapiRequiredFields.add("receiptRoot");
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      ...
      if (!jsonObj.get("transactionRoot").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `transactionRoot` to be a primitive type in the JSON string but got `%s`", jsonObj.get("transactionRoot").toString()));
      }
      ...
      if (!jsonObj.get("receiptRoot").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `receiptRoot` to be a primitive type in the JSON string but got `%s`", jsonObj.get("receiptRoot").toString()));
      }
      ...
      Web3BlockHeaderTimestamp.validateJsonObject(jsonObj.getAsJsonObject("timestamp"));
  }
