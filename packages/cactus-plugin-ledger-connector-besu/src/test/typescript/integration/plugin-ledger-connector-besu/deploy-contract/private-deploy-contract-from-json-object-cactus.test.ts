...
test(testCase, async (t: Test) => {
...

  {
    ...
    const contractInvocationNoPrivTxConfig = connector1.invokeContractPrivateTx(
      {
        contractName: HelloWorldContractJson.contractName,
        contractAbi: HelloWorldContractJson.abi,
...

  {
    ...
    const res = await connector1.invokeContractPrivateTx({
      contractName: HelloWorldContractJson.contractName,
      contractAbi: HelloWorldContractJson.abi,
      contractAddress: contractDeployReceipt.contractAddress,
...

  {
    ...
    const res = await connector2.invokeContractPrivateTx({
      contractName: HelloWorldContractJson.contractName,
      contractAbi: HelloWorldContractJson.abi,
      contractAddress: contractDeployReceipt.contractAddress,
      invocationType: EthContractInvocationType.Call,
...

  {
    ...
    const res = await connector3.invokeContractPrivateTx({
      contractName: HelloWorldContractJson.contractName,
      contractAbi: HelloWorldContractJson.abi,
      contractAddress: contractDeployReceipt.contractAddress,
      invocationType: EthContractInvocationType.Call,
