...
public class DeployContractJsonObjectV1Request {
  ...
  public DeployContractJsonObjectV1Request() {
  }

  public DeployContractJsonObjectV1Request web3SigningCredential(Web3SigningCredential web3SigningCredential) {
  ...
  **/
  ...
  public DeployContractJsonObjectV1Request gas(BigDecimal gas) {
  ...
  **/
  ...
  public DeployContractJsonObjectV1Request gasPrice(String gasPrice) {
  ...
  **/
  ...
  public DeployContractJsonObjectV1Request timeoutMs(BigDecimal timeoutMs) {
  ...
  **/
  ...
  public DeployContractJsonObjectV1Request contractJSON(ContractJSON contractJSON) {
  ...
  **/
  ...
  public DeployContractJsonObjectV1Request constructorArgs(List<Object> constructorArgs) {
    
    this.constructorArgs = constructorArgs;
    return this;
  }

  public DeployContractJsonObjectV1Request addConstructorArgsItem(Object constructorArgsItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    DeployContractJsonObjectV1Request deployContractJsonObjectV1Request = (DeployContractJsonObjectV1Request) o;
    return Objects.equals(this.web3SigningCredential, deployContractJsonObjectV1Request.web3SigningCredential) &&
        Objects.equals(this.gas, deployContractJsonObjectV1Request.gas) &&
        Objects.equals(this.gasPrice, deployContractJsonObjectV1Request.gasPrice) &&
        Objects.equals(this.timeoutMs, deployContractJsonObjectV1Request.timeoutMs) &&
        Objects.equals(this.contractJSON, deployContractJsonObjectV1Request.contractJSON) &&
        Objects.equals(this.constructorArgs, deployContractJsonObjectV1Request.constructorArgs);
  }
  ...
  public String toString() {
    ...
    sb.append("class DeployContractJsonObjectV1Request {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to DeployContractJsonObjectV1Request
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!DeployContractJsonObjectV1Request.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DeployContractJsonObjectV1Request is not found in the empty JSON string", DeployContractJsonObjectV1Request.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!DeployContractJsonObjectV1Request.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DeployContractJsonObjectV1Request` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : DeployContractJsonObjectV1Request.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DeployContractJsonObjectV1Request.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DeployContractJsonObjectV1Request' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DeployContractJsonObjectV1Request> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DeployContractJsonObjectV1Request.class));

       return (TypeAdapter<T>) new TypeAdapter<DeployContractJsonObjectV1Request>() {
           @Override
           public void write(JsonWriter out, DeployContractJsonObjectV1Request value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DeployContractJsonObjectV1Request read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of DeployContractJsonObjectV1Request given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of DeployContractJsonObjectV1Request
  * @throws IOException if the JSON string is invalid with respect to DeployContractJsonObjectV1Request
  */
  public static DeployContractJsonObjectV1Request fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DeployContractJsonObjectV1Request.class);
  }

 /**
  * Convert an instance of DeployContractJsonObjectV1Request to an JSON string
  *
  * @return JSON string
  */
