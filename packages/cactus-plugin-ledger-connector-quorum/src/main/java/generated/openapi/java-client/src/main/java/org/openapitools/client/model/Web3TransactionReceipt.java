...
public class Web3TransactionReceipt {
  ...
  public static final String SERIALIZED_NAME_CUMULATIVE_GAS_U_SED = "cumulativeGasUSed";
  @SerializedName(SERIALIZED_NAME_CUMULATIVE_GAS_U_SED)
  ...
  **/
  ...
  public Web3TransactionReceipt cumulativeGasUSed(BigDecimal cumulativeGasUSed) {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(status, transactionHash, transactionIndex, blockHash, blockNumber, gasUsed, contractAddress, from, to, logs, logsBloom, revertReason, output, commitmentHash, cumulativeGasUSed, additionalProperties);
  }
