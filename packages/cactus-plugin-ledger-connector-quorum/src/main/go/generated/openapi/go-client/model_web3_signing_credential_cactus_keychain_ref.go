...
func NewWeb3SigningCredentialCactusKeychainRef(type_ Web3SigningCredentialType, ethAccount string, keychainEntryKey string) *Web3SigningCredentialCactusKeychainRef {
...
func (o *Web3SigningCredentialCactusKeychainRef) HasKeychainId() bool {
	if o != nil && !IsNil(o.KeychainId) {
		return true
	}
