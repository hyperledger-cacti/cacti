...
type Web3TransactionReceipt struct {
	...
	CumulativeGasUSed *float32 `json:"cumulativeGasUSed,omitempty"`
...
func (o *Web3TransactionReceipt) GetCumulativeGasUSed() float32 {
...
// and a boolean to check if the value has been set.
func (o *Web3TransactionReceipt) GetCumulativeGasUSedOk() (*float32, bool) {
	if o == nil || IsNil(o.CumulativeGasUSed) {
		return nil, false
	}
...
// SetCumulativeGasUSed gets a reference to the given float32 and assigns it to the CumulativeGasUSed field.
func (o *Web3TransactionReceipt) SetCumulativeGasUSed(v float32) {
