...
func NewContractJSON(contractName string, bytecode string) *ContractJSON {
	this := ContractJSON{}
...
func (o *ContractJSON) HasAbi() bool {
	if o != nil && !IsNil(o.Abi) {
		return true
	}
...
// SetAbi gets a reference to the given []interface{} and assigns it to the Abi field.
