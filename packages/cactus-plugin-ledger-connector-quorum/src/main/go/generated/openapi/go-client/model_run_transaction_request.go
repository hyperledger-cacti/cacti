...
type RunTransactionRequest struct {
	...
	TransactionConfig QuorumTransactionConfig `json:"transactionConfig"`
...
func NewRunTransactionRequest(web3SigningCredential Web3SigningCredential, transactionConfig QuorumTransactionConfig) *RunTransactionRequest {
...
func (o *RunTransactionRequest) GetTransactionConfig() QuorumTransactionConfig {
	if o == nil {
		var ret QuorumTransactionConfig
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *RunTransactionRequest) GetTransactionConfigOk() (*QuorumTransactionConfig, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *RunTransactionRequest) SetTransactionConfig(v QuorumTransactionConfig) {
...
func (o *RunTransactionRequest) GetPrivateTransactionConfig() QuorumPrivateTransactionConfig {
...
// and a boolean to check if the value has been set.
func (o *RunTransactionRequest) GetPrivateTransactionConfigOk() (*QuorumPrivateTransactionConfig, bool) {
	if o == nil || IsNil(o.PrivateTransactionConfig) {
		return nil, false
	}
...
func (o *RunTransactionRequest) SetPrivateTransactionConfig(v QuorumPrivateTransactionConfig) {
