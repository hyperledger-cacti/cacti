...
func (o *WatchBlocksV1BlockData) GetNumber() float32 {
	if o == nil {
		var ret float32
		return ret
	}
...
func (o *WatchBlocksV1BlockData) GetNumberOk() (*float32, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *WatchBlocksV1BlockData) SetNumber(v float32) {
	o.Number = v
}
...
func (o *WatchBlocksV1BlockData) GetGasLimit() int32 {
	if o == nil {
		var ret int32
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *WatchBlocksV1BlockData) GetGasLimitOk() (*int32, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *WatchBlocksV1BlockData) SetGasLimit(v int32) {
	o.GasLimit = v
}

// GetGasUsed returns the GasUsed field value
func (o *WatchBlocksV1BlockData) GetGasUsed() int32 {
	if o == nil {
		var ret int32
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *WatchBlocksV1BlockData) GetGasUsedOk() (*int32, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *WatchBlocksV1BlockData) SetGasUsed(v int32) {
	o.GasUsed = v
}

// GetTimestamp returns the Timestamp field value
func (o *WatchBlocksV1BlockData) GetTimestamp() QuorumTransactionConfigFrom {
	if o == nil {
...
// and a boolean to check if the value has been set.
func (o *WatchBlocksV1BlockData) GetTimestampOk() (*QuorumTransactionConfigFrom, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *WatchBlocksV1BlockData) SetTimestamp(v QuorumTransactionConfigFrom) {
	o.Timestamp = v
}

// GetSize returns the Size field value
func (o *WatchBlocksV1BlockData) GetSize() float32 {
	if o == nil {
		var ret float32
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *WatchBlocksV1BlockData) GetSizeOk() (*float32, bool) {
	if o == nil {
		return nil, false
	}
	return &o.Size, true
...
func (o *WatchBlocksV1BlockData) SetSize(v float32) {
	o.Size = v
}
