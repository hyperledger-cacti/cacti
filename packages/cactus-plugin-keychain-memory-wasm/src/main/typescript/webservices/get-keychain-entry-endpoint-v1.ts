...
export class GetKeychainEntryV1Endpoint implements IWebServiceEndpoint {
  ...
  public getOasPath(): (typeof OAS.paths)["/api/v1/plugins/@hyperledger-cacti/cactus-plugin-keychain-memory-wasm/get-keychain-entry"] {
    return OAS.paths[
      "/api/v1/plugins/@hyperledger-cacti/cactus-plugin-keychain-memory-wasm/get-keychain-entry"
    ];
  }
