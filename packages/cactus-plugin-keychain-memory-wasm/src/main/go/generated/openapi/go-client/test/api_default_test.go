...
import (
	...
	"testing"
	openapiclient "github.com/hyperledger/cactus-plugin-keychain-memory-wasm/src/main/go/generated/openapi/go-client"
)

func Test_cactus-plugin-keychain-memory-wasm_DefaultApiService(t *testing.T) {
