...
import (
	...
	"testing"
	openapiclient "github.com/hyperledger/cactus-plugin-htlc-eth-besu-erc20/src/main/go/generated/openapi/go-client"
)

func Test_cactus-plugin-htlc-eth-besu-erc20_DefaultApiService(t *testing.T) {
