...
const deserializeRemoteProposal = (proposalBytes) =>
  fabproto6.protos.Proposal.decode(proposalBytes);
...
const deserializeRemoteProposalResponseHex = (proposalResponseBytesHex) =>
  fabproto6.protos.ProposalResponse.decode(
    Buffer.from(proposalResponseBytesHex, "hex"),
  );
...
const deserializeRemoteProposalResponseBase64 = (proposalResponseBytes64) =>
  fabproto6.protos.ProposalResponse.decode(
    Buffer.from(proposalResponseBytes64, "base64"),
  );
