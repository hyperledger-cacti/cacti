...
Assume that the `ledger initialization` of Corda networks was already carried out (refer to [Initializing the Corda Networks](https://hyperledger-cacti.github.io/cacti/weaver/getting-started/test-network/ledger-initialization/#initializing-the-corda-networks)).
