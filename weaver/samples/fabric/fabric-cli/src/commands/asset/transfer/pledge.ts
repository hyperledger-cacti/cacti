...
const command: GluegunCommand = {
  name: "pledge",
  description: "Pledges asset in one asset network to another",
  run: async (toolbox) => {
    const {
      print,
    ...
    if (options.help || options.h) {
      commandHelp(
        ...
        [
          ...
          {
            name: "--expiry-secs",
            description: "How long (in seconds) is the pledge valid for",
          },
          {
            name: "--type",
          ...
          {
            name: "--owner",
            description: "Asset owner ID used as key in the asset data file",
          },
          {
            name: "--ref",
            description: "Asset ID used as key in the asset data file",
          },
          {
            name: "--units",
            description: "Number of units of fungible asset",
          },
          {
            name: "--data-file",
            description: "Path to data file which stores assets in json format",
          },
        ],
        command,
