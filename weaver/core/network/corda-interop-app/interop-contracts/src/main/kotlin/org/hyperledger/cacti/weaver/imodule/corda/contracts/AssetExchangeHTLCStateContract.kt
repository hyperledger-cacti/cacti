...
import org.hyperledger.cacti.weaver.imodule.corda.states.AssetExchangeTxState
...
class AssetExchangeHTLCStateContract : Contract {
    companion object {
        ...
        const val ID = "org.hyperledger.cacti.weaver.imodule.corda.contracts.AssetExchangeHTLCStateContract"
    }
...
class AssetExchangeTxStateContract : Contract {
    companion object {
        // Used to identify our contract when building a transaction.
        const val ID = "org.hyperledger.cacti.weaver.imodule.corda.contracts.AssetExchangeTxStateContract"
    }
    override fun verify(tx: LedgerTransaction) {
        val command = tx.commands.requireSingleCommand<Commands>()
        when (command.value) {
