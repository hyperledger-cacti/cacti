...
import org.hyperledger.cacti.weaver.corda.app.interop.flows.*
import org.hyperledger.cacti.weaver.corda.app.interop.states.AssetExchangeHTLCState
import org.hyperledger.cacti.weaver.corda.app.interop.states.AssetLockHTLCData
import org.hyperledger.cacti.weaver.corda.app.interop.states.AssetClaimHTLCData

import org.hyperledger.cacti.weaver.corda.app.interop.test.*
...
class AssetExchangeHTLCWrapperTests {
    companion object {
        ...
        fun setup() {
            network = MockNetwork(MockNetworkParameters(cordappsForAllNodes = listOf(
                    ...
                    TestCordapp.findCordapp("org.hyperledger.cacti.weaver.corda.app.interop.test")
            )))
    ...
    val getAssetFlow = "org.hyperledger.cacti.weaver.corda.app.interop.test.GetAssetRef"
    val updateOwnerFlow = "org.hyperledger.cacti.weaver.corda.app.interop.test.UpdateOwnerFlow"
