...
import org.hyperledger.cacti.weaver.corda.app.interop.flows.CreateAccessControlPolicy
import org.hyperledger.cacti.weaver.corda.app.interop.flows.CreateExternalRequest
import org.hyperledger.cacti.weaver.corda.app.interop.flows.CreateVerificationPolicyState
import org.hyperledger.cacti.weaver.corda.app.interop.flows.verifyNodeSignature
import org.hyperledger.cacti.weaver.corda.app.interop.states.Policy
import org.hyperledger.cacti.weaver.corda.app.interop.states.VerificationPolicyState
import org.hyperledger.cacti.weaver.corda.app.interop.states.Identifier
    ...
    companion object {
        ...
        fun setup() {
            network = MockNetwork(MockNetworkParameters(cordappsForAllNodes = listOf(
                    TestCordapp.findCordapp("org.hyperledger.cacti.weaver.corda.app.interop.contracts"),
                    TestCordapp.findCordapp("org.hyperledger.cacti.weaver.corda.app.interop.flows")
            )))
