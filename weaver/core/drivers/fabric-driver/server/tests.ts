...
import queryPb from "@hyperledger-cacti/cacti-weaver-protos-js/common/query_pb";
import {
...
async function dbConnectionTest(): Promise<boolean> {
...
async function eventSubscriptionTest(
  ...
  try {
    ...
    const subscriptions: Array<queryPb.Query> = (await lookupEventSubscriptions(
      eventMatcher,
    )) as Array<queryPb.Query>;
...
export { dbConnectionTest, eventSubscriptionTest };
