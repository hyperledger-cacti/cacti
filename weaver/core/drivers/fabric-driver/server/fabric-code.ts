...
import view_data from "@hyperledger-cacti/cacti-weaver-protos-js/fabric/view_data_pb";
import proposalResponse from "@hyperledger-cacti/cacti-weaver-protos-js/peer/proposal_response_pb";
