...
describe("Membership", () => {
  ...
  describe("serialize membership", () => {
    it("test 1", async () => {
      ...
      console.log(ms64);
      expect(ms64).to.equal(
        "CgQyMzQ1EkIKB21lbWJlcjESNxILY2VydGlmaWNhdGUaDGNoYWluMS1jZXJ0MRoMY2hhaW4xLWNlcnQyGgxjaGFpbjEtY2VydDMSQgoHbWVtYmVyMhI3EgtjZXJ0aWZpY2F0ZRoMY2hhaW4yLWNlcnQxGgxjaGFpbjItY2VydDIaDGNoYWluMi1jZXJ0Mw==",
      );
    });
  });
});
