...
const (
	...
	Network_RequestAssetTransfer_FullMethodName      = "/networks.networks.Network/RequestAssetTransfer"
...
type NetworkClient interface {
	...
	RequestAssetTransfer(ctx context.Context, in *NetworkAssetTransfer, opts ...grpc.CallOption) (*common.Ack, error)
	// Event endpoints
...
func (c *networkClient) RequestAssetTransfer(ctx context.Context, in *NetworkAssetTransfer, opts ...grpc.CallOption) (*common.Ack, error) {
	out := new(common.Ack)
	err := c.cc.Invoke(ctx, Network_RequestAssetTransfer_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type NetworkServer interface {
	...
	// SATP endpoints
	// endpoint for a network to request asset transfer to a receiving gateway via local gateway
	RequestAssetTransfer(context.Context, *NetworkAssetTransfer) (*common.Ack, error)
	// Event endpoints
	// endpoint for a client to subscribe to event via local relay initiating subscription flow.
...
func (UnimplementedNetworkServer) RequestAssetTransfer(context.Context, *NetworkAssetTransfer) (*common.Ack, error) {
	return nil, status.Errorf(codes.Unimplemented, "method RequestAssetTransfer not implemented")
}
...
func _Network_RequestAssetTransfer_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(NetworkAssetTransfer)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(NetworkServer).RequestAssetTransfer(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Network_RequestAssetTransfer_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(NetworkServer).RequestAssetTransfer(ctx, req.(*NetworkAssetTransfer))
	}
	return interceptor(ctx, in, info, handler)
}
...
var Network_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "RequestAssetTransfer",
			Handler:    _Network_RequestAssetTransfer_Handler,
		},
		{
