    ...
    try {
      ...
      while (_alt != 2 && _alt != antlr4.atn.ATN.INVALID_ALT_NUMBER) {
        if (_alt === 1) {
          ...
          switch (la_) {
            case 1:
              localctx = new BooleanAndExpressionContext(
                this,
            ...
            case 2:
              localctx = new BooleanOrExpressionContext(
                this,
                new ExpressionContext(this, _parentctx, _parentState),
              );
              this.pushNewRecursionContext(
        ...
        case PolicyParser.COUNT:
          ...
          if (
            !(
              (_la & ~0x1f) == 0 &&
              ((1 << _la) &
                ((1 << PolicyParser.GREATER_THAN) |
                  (1 << PolicyParser.LESS_THAN) |
                  (1 << PolicyParser.GREATER_THAN_EQUAL) |
                  (1 << PolicyParser.LESS_THAN_EQUAL))) !==
                0
            )
          ) {
