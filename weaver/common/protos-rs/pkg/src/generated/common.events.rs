...
pub mod event_subscription_state {
    ...
    impl Status {
        ...
        pub fn as_str_name(&self) -> &'static str {
            match self {
                Self::SubscribePendingAck => "SUBSCRIBE_PENDING_ACK",
                Self::SubscribePending => "SUBSCRIBE_PENDING",
                Self::Subscribed => "SUBSCRIBED",
                Self::UnsubscribePendingAck => "UNSUBSCRIBE_PENDING_ACK",
                Self::UnsubscribePending => "UNSUBSCRIBE_PENDING",
                Self::Unsubscribed => "UNSUBSCRIBED",
                Self::Error => "ERROR",
                Self::DuplicateQuerySubscribed => "DUPLICATE_QUERY_SUBSCRIBED",
            }
        }
...
impl EventType {
    ...
    pub fn as_str_name(&self) -> &'static str {
        match self {
            ...
            Self::AssetLock => "ASSET_LOCK",
            Self::AssetClaim => "ASSET_CLAIM",
        }
    }
    /// Creates an enum from field names used in the ProtoBuf definition.
    pub fn from_str_name(value: &str) -> ::core::option::Option<Self> {
