--8<-- "START_HERE.md:content"

<!-- 
=============================================================================
MKDOCS REFERENCE LINKS
These links are used exclusively when the site is rendered via MkDocs.
Local GitHub users viewing the raw START_HERE.md file will use a different 
set of reference links defined at the bottom of that file.
=============================================================================
-->
...
[nix_setup]: ./guides/nix-setup.md
[build_nix_flake]: https://github.com/hyperledger-cacti/cacti/blob/main/BUILD.md#nix-flake-quickstart
[build_dev_container]: https://github.com/hyperledger-cacti/cacti/blob/main/BUILD.md#dev-container-quickstart-recommended
...
[getting_started_guide]: ./guides/getting-started.md
