...
The `state` either contains a `view` field (which is an instance of [View](./view-definition.md), if the view/data sharing request was successful), otherwise it consists of an error report.
