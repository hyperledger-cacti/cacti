...
class ConnectorQuorum extends Connector {
  ...
  /**
   * Add the public key of a foreign validator in the Quorum ledger
   * @param {string} pubKey
   * @param {string} name
   */
   ...
   * pubKey should match a registered foreignValidator in the Quorum ledger
  ...
  /**
   * Verify multiple signatures against registered foreignValidators in the Quorum ledger
...
module.exports = ConnectorQuorum;
