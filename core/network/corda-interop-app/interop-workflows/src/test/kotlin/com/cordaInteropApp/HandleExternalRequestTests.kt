...
class HandleExternalRequestTests {
    ...
    val query = QueryOuterClass.Query.newBuilder()
            ...
            .setCertificate(cert)
            .setRequestorSignature("nDdQtm5OKoMcYcB9v0bm4kfjZ6xpweB0X2X+kZqmdYY2B7tCcdjO+JH2ccAh0Fmo55KMZPHYWOxzjjE2FO9NDQ==")
            .setNonce("695e100f-4eb0-4d74-82e0-c59ebf90a2a5")
            .setRequestId("")
