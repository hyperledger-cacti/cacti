...
* Keep following Environment Variables in `.env` and delete/ignore rest:
    ...
    * DOCKER_IMAGE_VERSION: Version of the image in github registry. Check here: [weaver-relay-server](https://github.com/hyperledger-labs/weaver-dlt-interoperability/pkgs/container/weaver-relay-server)
