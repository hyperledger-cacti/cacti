...
echo "Test 3: Confirm EthSigner can connect to Besu. EthSigner suggests this test be done by requesting the current block number to the Besu network using the EthSigner JSON-RPC endpoint (Port: 8545). Expected output: a valid block number(anything other than an error should work)"
echo "Output: "
