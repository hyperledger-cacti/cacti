...
var file_networks_networks_proto_rawDesc = []byte{
	...
	0x72, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x49, 0x64, 0x32, 0xff, 0x03, 0x0a, 0x07, 0x4e, 0x65,
	...
	0x63, 0x72, 0x69, 0x70, 0x74, 0x69, 0x6f, 0x6e, 0x1a, 0x0f, 0x2e, 0x63, 0x6f, 0x6d, 0x6d, 0x6f,
	0x6e, 0x2e, 0x61, 0x63, 0x6b, 0x2e, 0x41, 0x63, 0x6b, 0x22, 0x00, 0x42, 0x78, 0x0a, 0x23, 0x63,
	...
	0x6b, 0x73, 0x5a, 0x51, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e, 0x63, 0x6f, 0x6d, 0x2f, 0x68,
	...
	0x6f, 0x6e, 0x2f, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x73, 0x2d, 0x67, 0x6f, 0x2f, 0x6e, 0x65, 0x74,
...
var file_networks_networks_proto_depIdxs = []int32{
	...
	9,  // 11: networks.networks.Network.RequestState:output_type -> common.ack.Ack
	10, // 12: networks.networks.Network.GetState:output_type -> common.state.RequestState
	1,  // 13: networks.networks.Network.RequestDatabase:output_type -> networks.networks.RelayDatabase
	9,  // 14: networks.networks.Network.SubscribeEvent:output_type -> common.ack.Ack
	11, // 15: networks.networks.Network.GetEventSubscriptionState:output_type -> common.events.EventSubscriptionState
	9,  // 16: networks.networks.Network.UnsubscribeEvent:output_type -> common.ack.Ack
