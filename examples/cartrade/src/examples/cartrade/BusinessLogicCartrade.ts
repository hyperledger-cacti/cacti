...
import { BusinessLogicBase } from '../../business-logic-plugin/BusinessLogicBase';
...
export class BusinessLogicCartrade extends BusinessLogicBase {
    ...
    firstTransaction(requestInfo: RequestInfo, tradeInfo: TradeInfo) {
        ...
        const verifierEthereum = transactionManagement.getVerifier("84jUisrs");
    ...
    secondTransaction(carID: string, fabricAccountTo: string, tradeInfo: TradeInfo) {
        ...
        // Get Verifier Instance
        const verifierFabric = transactionManagement.getVerifier("r9IS4dDf");
