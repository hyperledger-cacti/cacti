...
import {
  ApiInfo,
  LedgerEvent,
} from "../../packages/ledger-plugin/LedgerPlugin";
...
export class BusinessLogicCartrade extends BusinessLogicBase {
  ...
  firstTransaction(requestInfo: RequestInfo, tradeInfo: TradeInfo) {
    ...
    const verifierEthereum = transactionManagement.getVerifier(
  ...
  secondTransaction(
    ...
    const verifierFabric = transactionManagement.getVerifier(
