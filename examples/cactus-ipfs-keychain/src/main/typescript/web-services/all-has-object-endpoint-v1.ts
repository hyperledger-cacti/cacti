...
export interface IAllHasObjectEndpointV1Options {
  readonly logLevel?: LogLevelDesc;
  readonly plugin: IPluginObjectStore;
}

export class AllHasObjectEndpointV1 implements IWebServiceEndpoint {
  ...
  public get className(): string {
    return AllHasObjectEndpointV1.CLASS_NAME;
  }

  constructor(public readonly options: IAllHasObjectEndpointV1Options) {
  ...
  private getOperation() {
    return OAS.paths[
      "/api/v1/plugins/@hyperledger/cactus-plugin-object-store-ipfs/all-has-object"
    ].post;
  }
  ...
  async handleRequest(req: Request, res: Response): Promise<void> {
    ...
    try {
      const reqBody = req.body as AllHasObjectRequestV1;
