...
export class ListBookshelfEndpoint implements IWebServiceEndpoint {
  ...
  public getOasPath(): (typeof OAS.paths)["/api/v1/plugins/@hyperledger-cacti/cactus-example-supply-chain-backend/list-bookshelf"] {
    return OAS.paths[
      "/api/v1/plugins/@hyperledger-cacti/cactus-example-supply-chain-backend/list-bookshelf"
    ];
  }
