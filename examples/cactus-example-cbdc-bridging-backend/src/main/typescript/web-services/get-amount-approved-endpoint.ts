...
export class GetAmountApprovedEndpointV1 implements IWebServiceEndpoint {
  ...
  public get oasPath(): (typeof OAS.paths)["/api/v1/@hyperledger-cacti/cactus-example-cbdc/get-amount-approved"] {
    return OAS.paths[
      "/api/v1/@hyperledger-cacti/cactus-example-cbdc/get-amount-approved"
    ];
  }
