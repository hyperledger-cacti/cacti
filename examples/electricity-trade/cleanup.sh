...
docker stop geth1
docker stop gethtestnet_init-chain-geth1_run_1
docker stop gethtestnet_init-chain-geth1_run_2
...
docker rm geth1
docker rm gethtestnet_init-chain-geth1_run_1
docker rm gethtestnet_init-chain-geth1_run_2
